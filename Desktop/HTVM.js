...
function debugger_HTVM(code) {
    ...
    for (let A_Index182 = 0; A_Index182 < items182.length; A_Index182++) {
        ...
        if (Trim(A_LoopField182) == "debuger--aJHCBAKCAhtvmnHTVM--ACJAKHBaSSshad88sjhb-DEBUGER--HTVM--sjcvas") {
            counterDebugger++;
            out += "input(" + Chr(34) + "(PRESS ENTER TO CONTINUE) - Breakpoint: " + STR(counterDebugger) + Chr(34) + ")" + Chr(10);
        } else {
...
function compiler(htCode, allInstructionFile, mode, langToConvertToParam = "") {
    ...
    for (let A_Index183 = 0; A_Index183 < items183.length; A_Index183++) {
        ...
        HTVM_Append(FIXFIX_allInstructionFile_ARR, A_LoopField183);
    }
    let items184 = LoopParseFunc(instructions);
    for (let A_Index184 = 0; A_Index184 < items184.length; A_Index184++) {
        const A_LoopField184 = items184[A_Index184 - 0];
        if (A_LoopField184 == Chr(10)) {
        ...
        if (FIXFIX_allInstructionFile_HELP_done == 1) {
            FIXFIX_allInstructionFile += A_LoopField184;
        } else {
            if (FIXFIX_allInstructionFile_ARR[A_Index184 + 1] == Chr(10) && A_LoopField184 == Chr(10)) {
    ...
    for (let A_Index185 = 0; A_Index185 < items185.length; A_Index185++) {
        ...
        if (A_Index185 == 161 && Trim(A_LoopField185) != "on" && Trim(A_LoopField185) != "off") {
    ...
    for (let A_Index186 = 0; A_Index186 < items186.length; A_Index186++) {
        ...
        if (A_Index186 == 0) {
            langToConvertTo = Trim(A_LoopField186);
        }
        if (A_Index186 == 1) {
            langFileExtension = Trim(A_LoopField186);
        }
        if (A_Index186 == 2) {
            commands = Trim(A_LoopField186);
        }
        if (A_Index186 == 3) {
            keyWordAlliance = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 4) {
            keyWordCrew = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 5) {
            keyWordProc = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 6) {
            keyWordStruct = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 7) {
            keyWordProp = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 8) {
            keyWordThis = Trim(A_LoopField186);
        }
        if (A_Index186 == 9) {
            keyWordInclude = Trim(A_LoopField186);
        }
        if (A_Index186 == 10) {
            keyWordCodeInTheTranspiledLangStart = Trim(A_LoopField186);
        }
        if (A_Index186 == 11) {
            keyWordCodeInTheTranspiledLangEnd = Trim(A_LoopField186);
        }
        if (A_Index186 == 12) {
            keyWordCodeInTheTranspiledLangStartCPP = Trim(A_LoopField186);
        }
        if (A_Index186 == 13) {
            keyWordCodeInTheTranspiledLangEndCPP = Trim(A_LoopField186);
        }
        if (A_Index186 == 14) {
            keyWordCodeInTheTranspiledLangStartPY = Trim(A_LoopField186);
        }
        if (A_Index186 == 15) {
            keyWordCodeInTheTranspiledLangEndPY = Trim(A_LoopField186);
        }
        if (A_Index186 == 16) {
            keyWordCodeInTheTranspiledLangStartJS = Trim(A_LoopField186);
        }
        if (A_Index186 == 17) {
            keyWordCodeInTheTranspiledLangEndJS = Trim(A_LoopField186);
        }
        if (A_Index186 == 18) {
            keyWordCodeInTheTranspiledLangStartGO = Trim(A_LoopField186);
        }
        if (A_Index186 == 19) {
            keyWordCodeInTheTranspiledLangEndGO = Trim(A_LoopField186);
        }
        if (A_Index186 == 20) {
            keyWordCodeInTheTranspiledLangStartLUA = Trim(A_LoopField186);
        }
        if (A_Index186 == 21) {
            keyWordCodeInTheTranspiledLangEndLUA = Trim(A_LoopField186);
        }
        if (A_Index186 == 22) {
            keyWordCodeInTheTranspiledLangStartCS = Trim(A_LoopField186);
        }
        if (A_Index186 == 23) {
            keyWordCodeInTheTranspiledLangEndCS = Trim(A_LoopField186);
        }
        if (A_Index186 == 24) {
            keyWordCodeInTheTranspiledLangStartJAVA = Trim(A_LoopField186);
        }
        if (A_Index186 == 25) {
            keyWordCodeInTheTranspiledLangEndJAVA = Trim(A_LoopField186);
        }
        if (A_Index186 == 26) {
            keyWordCodeInTheTranspiledLangStartKT = Trim(A_LoopField186);
        }
        if (A_Index186 == 27) {
            keyWordCodeInTheTranspiledLangEndKT = Trim(A_LoopField186);
        }
        if (A_Index186 == 28) {
            keyWordCodeInTheTranspiledLangStartRB = Trim(A_LoopField186);
        }
        if (A_Index186 == 29) {
            keyWordCodeInTheTranspiledLangEndRB = Trim(A_LoopField186);
        }
        if (A_Index186 == 30) {
            keyWordCodeInTheTranspiledLangStartNIM = Trim(A_LoopField186);
        }
        if (A_Index186 == 31) {
            keyWordCodeInTheTranspiledLangEndNIM = Trim(A_LoopField186);
        }
        if (A_Index186 == 32) {
            keyWordCodeInTheTranspiledLangStartAHK = Trim(A_LoopField186);
        }
        if (A_Index186 == 33) {
            keyWordCodeInTheTranspiledLangEndAHK = Trim(A_LoopField186);
        }
        if (A_Index186 == 34) {
            keyWordCodeInTheTranspiledLangStartSWIFT = Trim(A_LoopField186);
        }
        if (A_Index186 == 35) {
            keyWordCodeInTheTranspiledLangEndSWIFT = Trim(A_LoopField186);
        }
        if (A_Index186 == 36) {
            keyWordCodeInTheTranspiledLangStartDART = Trim(A_LoopField186);
        }
        if (A_Index186 == 37) {
            keyWordCodeInTheTranspiledLangEndDART = Trim(A_LoopField186);
        }
        if (A_Index186 == 38) {
            keyWordCodeInTheTranspiledLangStartTS = Trim(A_LoopField186);
        }
        if (A_Index186 == 39) {
            keyWordCodeInTheTranspiledLangEndTS = Trim(A_LoopField186);
        }
        if (A_Index186 == 40) {
            keyWordCodeInTheTranspiledLangStartGROOVY = Trim(A_LoopField186);
        }
        if (A_Index186 == 41) {
            keyWordCodeInTheTranspiledLangEndGROOVY = Trim(A_LoopField186);
        }
        if (A_Index186 == 42) {
            keyWordCodeInTheTranspiledLangStartHTVM = Trim(A_LoopField186);
        }
        if (A_Index186 == 43) {
            keyWordCodeInTheTranspiledLangEndHTVM = Trim(A_LoopField186);
        }
        if (A_Index186 == 44) {
            keyWordCodeInHTVMstart = Trim(A_LoopField186);
        }
        if (A_Index186 == 45) {
            keyWordCodeInHTVMend = Trim(A_LoopField186);
        }
        if (A_Index186 == 46) {
            keyWordCurlyBraceOpen = Trim(A_LoopField186);
        }
        if (A_Index186 == 47) {
            keyWordCurlyBraceClose = Trim(A_LoopField186);
        }
        if (A_Index186 == 48) {
            keyWordNull = Trim(A_LoopField186);
        }
        if (A_Index186 == 49) {
            keyWordTrue = Trim(A_LoopField186);
        }
        if (A_Index186 == 50) {
            keyWordFalse = Trim(A_LoopField186);
        }
        if (A_Index186 == 51) {
            keyWordVoid = Trim(A_LoopField186);
        }
        if (A_Index186 == 52) {
            keyWordDouble = Trim(A_LoopField186);
        }
        if (A_Index186 == 53) {
            keyWordChar = Trim(A_LoopField186);
        }
        if (A_Index186 == 54) {
            keyWordUint8 = Trim(A_LoopField186);
        }
        if (A_Index186 == 55) {
            keyWordUint16 = Trim(A_LoopField186);
        }
        if (A_Index186 == 56) {
            keyWordUint32 = Trim(A_LoopField186);
        }
        if (A_Index186 == 57) {
            keyWordUint64 = Trim(A_LoopField186);
        }
        if (A_Index186 == 58) {
            keyWordINT = Trim(A_LoopField186);
        }
        if (A_Index186 == 59) {
            keyWordSTR = Trim(A_LoopField186);
        }
        if (A_Index186 == 60) {
            keyWordBOOL = Trim(A_LoopField186);
        }
        if (A_Index186 == 61) {
            keyWordFLOAT = Trim(A_LoopField186);
        }
        if (A_Index186 == 62) {
            keyWordINT8 = Trim(A_LoopField186);
        }
        if (A_Index186 == 63) {
            keyWordINT16 = Trim(A_LoopField186);
        }
        if (A_Index186 == 64) {
            keyWordINT32 = Trim(A_LoopField186);
        }
        if (A_Index186 == 65) {
            keyWordINT64 = Trim(A_LoopField186);
        }
        if (A_Index186 == 66) {
            keyWordIF = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 67) {
            keyWordElseIf = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 68) {
            keyWordElse = Trim(A_LoopField186);
        }
        if (A_Index186 == 69) {
            keyWordWhileLoop = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 70) {
            keyWordLoopInfinite = Trim(A_LoopField186);
        }
        if (A_Index186 == 71) {
            keyWordLoop = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 72) {
            keyWordLoopParse = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 73) {
            keyWordContinue = Trim(A_LoopField186);
        }
        if (A_Index186 == 74) {
            keyWordBreak = Trim(A_LoopField186);
        }
        if (A_Index186 == 75) {
            keyWordFunc = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 76) {
            keyWordAwait = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 77) {
            keyWordAsync = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 78) {
            keyWordThrow = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 79) {
            keyWordErrorMsg = Trim(A_LoopField186);
        }
        if (A_Index186 == 80) {
            keyWordTry = Trim(A_LoopField186);
        }
        if (A_Index186 == 81) {
            keyWordCatch = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 82) {
            keyWordFinally = Trim(A_LoopField186);
        }
        if (A_Index186 == 83) {
            keyWordReturnStatement = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 84) {
            keyWordArrayAppend = Trim(A_LoopField186);
        }
        if (A_Index186 == 85) {
            keyWordArrayPop = Trim(A_LoopField186);
        }
        if (A_Index186 == 86) {
            keyWordArraySize = Trim(A_LoopField186);
        }
        if (A_Index186 == 87) {
            keyWordArrayInsert = Trim(A_LoopField186);
        }
        if (A_Index186 == 88) {
            keyWordArrayRemove = Trim(A_LoopField186);
        }
        if (A_Index186 == 89) {
            keyWordArrayIndexOf = Trim(A_LoopField186);
        }
        if (A_Index186 == 90) {
            keyWordArrayDefinition = Trim(A_LoopField186);
        }
        if (A_Index186 == 91) {
            keyWordArrayOfIntegersDefinition = Trim(A_LoopField186);
        }
        if (A_Index186 == 92) {
            keyWordArrayOfStringsDefinition = Trim(A_LoopField186);
        }
        if (A_Index186 == 93) {
            keyWordArrayOfFloatingPointNumbersDefinition = Trim(A_LoopField186);
        }
        if (A_Index186 == 94) {
            keyWordArrayOfBooleansDefinition = Trim(A_LoopField186);
        }
        if (A_Index186 == 95) {
            keyWordVar = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 96) {
            keyWordLet = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 97) {
            keyWordConst = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 98) {
            keyWordEnd = Trim(A_LoopField186);
        }
        if (A_Index186 == 99) {
            keyWordGlobal = Trim(A_LoopField186) + " ";
        }
        if (A_Index186 == 100) {
            keyWordComment = Trim(A_LoopField186);
        }
        if (A_Index186 == 101) {
            keyWordCommentOpenMultiLine = Trim(A_LoopField186);
        }
        if (A_Index186 == 102) {
            keyWordCommentCloseMultiLine = Trim(A_LoopField186);
        }
        if (A_Index186 == 103) {
            keyWordEscpaeChar = Trim(A_LoopField186);
        }
        if (A_Index186 == 104) {
            keyWordMainLabel = Trim(A_LoopField186);
        }
        if (A_Index186 == 105) {
            keyWordConcat = Trim(A_LoopField186);
        }
        if (A_Index186 == 106) {
            keyWordAdd = Trim(A_LoopField186);
        }
        if (A_Index186 == 107) {
            keyWordSub = Trim(A_LoopField186);
        }
        if (A_Index186 == 108) {
            keyWordMul = Trim(A_LoopField186);
        }
        if (A_Index186 == 109) {
            keyWordDiv = Trim(A_LoopField186);
        }
        if (A_Index186 == 110) {
            keyWordMod = Trim(A_LoopField186);
        }
        if (A_Index186 == 111) {
            keyWordExp = Trim(A_LoopField186);
        }
        if (A_Index186 == 112) {
            keyWordEqual = Trim(A_LoopField186);
        }
        if (A_Index186 == 113) {
            keyWordStrictEqual = Trim(A_LoopField186);
        }
        if (A_Index186 == 114) {
            keyWordNotEqual = Trim(A_LoopField186);
        }
        if (A_Index186 == 115) {
            keyWordGreater = Trim(A_LoopField186);
        }
        if (A_Index186 == 116) {
            keyWordLess = Trim(A_LoopField186);
        }
        if (A_Index186 == 117) {
            keyWordGreaterEqual = Trim(A_LoopField186);
        }
        if (A_Index186 == 118) {
            keyWordLessEqual = Trim(A_LoopField186);
        }
        if (A_Index186 == 119) {
            keyWordAnd = Trim(A_LoopField186);
        }
        if (A_Index186 == 120) {
            keyWordOr = Trim(A_LoopField186);
        }
        if (A_Index186 == 121) {
            keyWordNot = Trim(A_LoopField186);
        }
        if (A_Index186 == 122) {
            keyWordBitAnd = Trim(A_LoopField186);
        }
        if (A_Index186 == 123) {
            keyWordBitOr = Trim(A_LoopField186);
        }
        if (A_Index186 == 124) {
            keyWordBitXor = Trim(A_LoopField186);
        }
        if (A_Index186 == 125) {
            keyWordBitNot = Trim(A_LoopField186);
        }
        if (A_Index186 == 126) {
            keyWordShiftLeft = Trim(A_LoopField186);
        }
        if (A_Index186 == 127) {
            keyWordShiftRight = Trim(A_LoopField186);
        }
        if (A_Index186 == 128) {
            keyWordShiftUnsignedRight = Trim(A_LoopField186);
        }
        if (A_Index186 == 129) {
            keyWordAssign = Trim(A_LoopField186);
        }
        if (A_Index186 == 130) {
            keyWordAssignAdd = Trim(A_LoopField186);
        }
        if (A_Index186 == 131) {
            keyWordAssignConcat = Trim(A_LoopField186);
        }
        if (A_Index186 == 132) {
            keyWordAssignSub = Trim(A_LoopField186);
        }
        if (A_Index186 == 133) {
            keyWordAssignMul = Trim(A_LoopField186);
        }
        if (A_Index186 == 134) {
            keyWordAssignDiv = Trim(A_LoopField186);
        }
        if (A_Index186 == 135) {
            keyWordAssignMod = Trim(A_LoopField186);
        }
        if (A_Index186 == 136) {
            keyWordAssignShiftLeft = Trim(A_LoopField186);
        }
        if (A_Index186 == 137) {
            keyWordAssignShiftRight = Trim(A_LoopField186);
        }
        if (A_Index186 == 138) {
            keyWordLogicalAssignShiftRight = Trim(A_LoopField186);
        }
        if (A_Index186 == 139) {
            keyWordAssignBitAnd = Trim(A_LoopField186);
        }
        if (A_Index186 == 140) {
            keyWordAssignBitOr = Trim(A_LoopField186);
        }
        if (A_Index186 == 141) {
            keyWordAssignBitXor = Trim(A_LoopField186);
        }
        if (A_Index186 == 142) {
            keyWordTernary1 = Trim(A_LoopField186);
        }
        if (A_Index186 == 143) {
            keyWordTernary2 = Trim(A_LoopField186);
        }
        if (A_Index186 == 144) {
            keyWordInc = Trim(A_LoopField186);
        }
        if (A_Index186 == 145) {
            keyWordDec = Trim(A_LoopField186);
        }
        if (A_Index186 == 146) {
            AHKlikeLoopsIndexedAt = Trim(A_LoopField186);
        }
        if (A_Index186 == 147) {
            keyWordAIndex = Trim(A_LoopField186);
        }
        if (A_Index186 == 148) {
            keyWordALoopField = Trim(A_LoopField186);
        }
        if (A_Index186 == 149) {
            useCurlyBraces = Trim(A_LoopField186);
        }
        if (A_Index186 == 150) {
            useEnd = Trim(A_LoopField186);
        }
        if (A_Index186 == 151) {
            useSemicolon = Trim(A_LoopField186);
        }
        if (A_Index186 == 152) {
            useParentheses = Trim(A_LoopField186);
        }
        if (A_Index186 == 153) {
            usePrefixTypeForTypeDefinition = Trim(A_LoopField186);
        }
        if (A_Index186 == 154) {
            usePostfixTypeForTypeDefinition = Trim(A_LoopField186);
        }
        if (panic_FIXFIX_allInstructionFile == 1) {
            if (A_Index186 == 155) {
                usePythonicColonSyntax = Trim(A_LoopField186);
            }
            if (A_Index186 == 155) {
                useCurlyBracesSyntaxForArrayDef = Trim(A_LoopField186);
            }
            if (A_Index186 == 156) {
                useInJavaScriptAlwaysUseVar = Trim(A_LoopField186);
            }
            if (A_Index186 == 157) {
                useJavaScriptInAfullHTMLfile = Trim(A_LoopField186);
            }
            if (A_Index186 == 158) {
                useJavaScriptAmainFuncDef = Trim(A_LoopField186);
            }
            if (A_Index186 == 159) {
                useJavaScriptAllFuncsAreAsync = Trim(A_LoopField186);
            }
            if (A_Index186 == 160) {
                useJavaScriptAlwaysTripleEqual = Trim(A_LoopField186);
            }
        } else {
            if (A_Index186 == 155) {
                usePythonicColonSyntax = Trim(A_LoopField186);
    ...
    if (HTVM_Size(argHTVMinstrMORE) > 0) {
        ...
        let items187 = LoopParseFunc(allInstructionFile_2, "\n", "\r");
        for (let A_Index187 = 0; A_Index187 < items187.length; A_Index187++) {
            const A_LoopField187 = items187[A_Index187 - 0];
            if (A_Index187 == 0) {
                langToConvertTo_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 1) {
                langFileExtension_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 2) {
                commands_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 3) {
                keyWordAlliance_2 = Trim(A_LoopField187) + " ";
            }
            if (A_Index187 == 4) {
                keyWordCrew_2 = Trim(A_LoopField187) + " ";
            }
            if (A_Index187 == 5) {
                keyWordProc_2 = Trim(A_LoopField187) + " ";
            }
            if (A_Index187 == 6) {
                keyWordStruct_2 = Trim(A_LoopField187) + " ";
            }
            if (A_Index187 == 7) {
                keyWordProp_2 = Trim(A_LoopField187) + " ";
            }
            if (A_Index187 == 8) {
                keyWordThis_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 9) {
                keyWordInclude_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 10) {
                keyWordCodeInTheTranspiledLangStart_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 11) {
                keyWordCodeInTheTranspiledLangEnd_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 12) {
                keyWordCodeInTheTranspiledLangStartCPP_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 13) {
                keyWordCodeInTheTranspiledLangEndCPP_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 14) {
                keyWordCodeInTheTranspiledLangStartPY_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 15) {
                keyWordCodeInTheTranspiledLangEndPY_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 16) {
                keyWordCodeInTheTranspiledLangStartJS_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 17) {
                keyWordCodeInTheTranspiledLangEndJS_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 18) {
                keyWordCodeInTheTranspiledLangStartGO_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 19) {
                keyWordCodeInTheTranspiledLangEndGO_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 20) {
                keyWordCodeInTheTranspiledLangStartLUA_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 21) {
                keyWordCodeInTheTranspiledLangEndLUA_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 22) {
                keyWordCodeInTheTranspiledLangStartCS_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 23) {
                keyWordCodeInTheTranspiledLangEndCS_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 24) {
                keyWordCodeInTheTranspiledLangStartJAVA_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 25) {
                keyWordCodeInTheTranspiledLangEndJAVA_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 26) {
                keyWordCodeInTheTranspiledLangStartKT_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 27) {
                keyWordCodeInTheTranspiledLangEndKT_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 28) {
                keyWordCodeInTheTranspiledLangStartRB_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 29) {
                keyWordCodeInTheTranspiledLangEndRB_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 30) {
                keyWordCodeInTheTranspiledLangStartNIM_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 31) {
                keyWordCodeInTheTranspiledLangEndNIM_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 32) {
                keyWordCodeInTheTranspiledLangStartAHK_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 33) {
                keyWordCodeInTheTranspiledLangEndAHK_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 34) {
                keyWordCodeInTheTranspiledLangStartSWIFT_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 35) {
                keyWordCodeInTheTranspiledLangEndSWIFT_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 36) {
                keyWordCodeInTheTranspiledLangStartDART_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 37) {
                keyWordCodeInTheTranspiledLangEndDART_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 38) {
                keyWordCodeInTheTranspiledLangStartTS_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 39) {
                keyWordCodeInTheTranspiledLangEndTS_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 40) {
                keyWordCodeInTheTranspiledLangStartGROOVY_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 41) {
                keyWordCodeInTheTranspiledLangEndGROOVY_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 42) {
                keyWordCodeInTheTranspiledLangStartHTVM_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 43) {
                keyWordCodeInTheTranspiledLangEndHTVM_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 44) {
                keyWordCodeInHTVMstart_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 45) {
                keyWordCodeInHTVMend_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 46) {
                keyWordCurlyBraceOpen_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 47) {
                keyWordCurlyBraceClose_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 48) {
                keyWordNull_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 49) {
                keyWordTrue_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 50) {
                keyWordFalse_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 51) {
                keyWordVoid_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 52) {
                keyWordDouble_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 53) {
                keyWordChar_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 54) {
                keyWordUint8_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 55) {
                keyWordUint16_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 56) {
                keyWordUint32_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 57) {
                keyWordUint64_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 58) {
                keyWordINT_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 59) {
                keyWordSTR_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 60) {
                keyWordBOOL_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 61) {
                keyWordFLOAT_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 62) {
                keyWordINT8_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 63) {
                keyWordINT16_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 64) {
                keyWordINT32_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 65) {
                keyWordINT64_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 66) {
                keyWordIF_2 = Trim(A_LoopField187) + " ";
            }
            if (A_Index187 == 67) {
                keyWordElseIf_2 = Trim(A_LoopField187) + " ";
            }
            if (A_Index187 == 68) {
                keyWordElse_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 69) {
                keyWordWhileLoop_2 = Trim(A_LoopField187) + " ";
            }
            if (A_Index187 == 70) {
                keyWordLoopInfinite_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 71) {
                keyWordLoop_2 = Trim(A_LoopField187) + " ";
            }
            if (A_Index187 == 72) {
                keyWordLoopParse_2 = Trim(A_LoopField187) + " ";
            }
            if (A_Index187 == 73) {
                keyWordContinue_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 74) {
                keyWordBreak_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 75) {
                keyWordFunc_2 = Trim(A_LoopField187) + " ";
            }
            if (A_Index187 == 76) {
                keyWordAwait_2 = Trim(A_LoopField187) + " ";
            }
            if (A_Index187 == 77) {
                keyWordAsync_2 = Trim(A_LoopField187) + " ";
            }
            if (A_Index187 == 78) {
                keyWordThrow_2 = Trim(A_LoopField187) + " ";
            }
            if (A_Index187 == 79) {
                keyWordErrorMsg_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 80) {
                keyWordTry_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 81) {
                keyWordCatch_2 = Trim(A_LoopField187) + " ";
            }
            if (A_Index187 == 82) {
                keyWordFinally_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 83) {
                keyWordReturnStatement_2 = Trim(A_LoopField187) + " ";
            }
            if (A_Index187 == 84) {
                keyWordArrayAppend_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 85) {
                keyWordArrayPop_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 86) {
                keyWordArraySize_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 87) {
                keyWordArrayInsert_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 88) {
                keyWordArrayRemove_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 89) {
                keyWordArrayIndexOf_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 90) {
                keyWordArrayDefinition_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 91) {
                keyWordArrayOfIntegersDefinition_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 92) {
                keyWordArrayOfStringsDefinition_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 93) {
                keyWordArrayOfFloatingPointNumbersDefinition_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 94) {
                keyWordArrayOfBooleansDefinition_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 95) {
                keyWordVar_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 96) {
                keyWordLet_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 97) {
                keyWordConst_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 98) {
                keyWordEnd_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 99) {
                keyWordGlobal_2 = Trim(A_LoopField187) + " ";
            }
            if (A_Index187 == 100) {
                keyWordComment_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 101) {
                keyWordCommentOpenMultiLine_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 102) {
                keyWordCommentCloseMultiLine_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 103) {
                keyWordEscpaeChar_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 104) {
                keyWordMainLabel_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 105) {
                keyWordConcat_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 106) {
                keyWordAdd_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 107) {
                keyWordSub_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 108) {
                keyWordMul_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 109) {
                keyWordDiv_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 110) {
                keyWordMod_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 111) {
                keyWordExp_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 112) {
                keyWordEqual_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 113) {
                keyWordStrictEqual_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 114) {
                keyWordNotEqual_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 115) {
                keyWordGreater_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 116) {
                keyWordLess_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 117) {
                keyWordGreaterEqual_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 118) {
                keyWordLessEqual_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 119) {
                keyWordAnd_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 120) {
                keyWordOr_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 121) {
                keyWordNot_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 122) {
                keyWordBitAnd_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 123) {
                keyWordBitOr_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 124) {
                keyWordBitXor_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 125) {
                keyWordBitNot_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 126) {
                keyWordShiftLeft_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 127) {
                keyWordShiftRight_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 128) {
                keyWordShiftUnsignedRight_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 129) {
                keyWordAssign_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 130) {
                keyWordAssignAdd_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 131) {
                keyWordAssignConcat_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 132) {
                keyWordAssignSub_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 133) {
                keyWordAssignMul_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 134) {
                keyWordAssignDiv_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 135) {
                keyWordAssignMod_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 136) {
                keyWordAssignShiftLeft_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 137) {
                keyWordAssignShiftRight_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 138) {
                keyWordLogicalAssignShiftRight_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 139) {
                keyWordAssignBitAnd_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 140) {
                keyWordAssignBitOr_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 141) {
                keyWordAssignBitXor_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 142) {
                keyWordTernary1_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 143) {
                keyWordTernary2_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 144) {
                keyWordInc_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 145) {
                keyWordDec_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 146) {
                AHKlikeLoopsIndexedAt_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 147) {
                keyWordAIndex_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 148) {
                keyWordALoopField_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 149) {
                useCurlyBraces_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 150) {
                useEnd_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 151) {
                useSemicolon_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 152) {
                useParentheses_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 153) {
                usePrefixTypeForTypeDefinition_2 = Trim(A_LoopField187);
            }
            if (A_Index187 == 154) {
                usePostfixTypeForTypeDefinition_2 = Trim(A_LoopField187);
            }
            if (panic_FIXFIX_allInstructionFile == 1) {
                if (A_Index187 == 155) {
                    usePythonicColonSyntax_2 = Trim(A_LoopField187);
                }
                if (A_Index187 == 155) {
                    useCurlyBracesSyntaxForArrayDef_2 = Trim(A_LoopField187);
                }
                if (A_Index187 == 156) {
                    useInJavaScriptAlwaysUseVar_2 = Trim(A_LoopField187);
                }
                if (A_Index187 == 157) {
                    useJavaScriptInAfullHTMLfile_2 = Trim(A_LoopField187);
                }
                if (A_Index187 == 158) {
                    useJavaScriptAmainFuncDef_2 = Trim(A_LoopField187);
                }
                if (A_Index187 == 159) {
                    useJavaScriptAllFuncsAreAsync_2 = Trim(A_LoopField187);
                }
                if (A_Index187 == 160) {
                    useJavaScriptAlwaysTripleEqual_2 = Trim(A_LoopField187);
                }
            } else {
                if (A_Index187 == 155) {
                    usePythonicColonSyntax_2 = Trim(A_LoopField187);
    ...
    */
    ...
    let items188 = LoopParseFunc(allInstructionFile, "\n", "\r");
    for (let A_Index188 = 0; A_Index188 < items188.length; A_Index188++) {
        const A_LoopField188 = items188[A_Index188 - 0];
        if (RegExMatch(Trim(A_LoopField188), "^name: [A-Za-z0-9_]+")) {
            availableFuncsInHTVMInHTVM += Trim(StrSplit(Trim(A_LoopField188), "name: ", 2)) + Chr(10);
        }
    }
    ...
    if (isNotHTVMfile == 0) {
        if (langToConvertTo != langFileExtension_2) {
            ...
            if (doseHaveInclude(code)) {
                ...
                for (let A_Index190 = 0; A_Index190 < 10000; A_Index190++) {
                    ...
                    for (let A_Index191 = 0; A_Index191 < items191.length; A_Index191++) {
                        ...
                        if (SubStr(StrLower(Trim(currentLine)), 1, StrLen(keyWordInclude + " ")) == StrLower(keyWordInclude + " ")) {
                            ...
                            for (let A_Index192 = 0; A_Index192 < HTVM_Size(includedFilePaths); A_Index192++) {
                                if (filePathToInclude == includedFilePaths[A_Index192]) {
        ...
        for (let A_Index193 = 0; A_Index193 < items193.length; A_Index193++) {
            ...
            if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangEnd)) {
                COUNT_programmingBlock_InTheTranspiledLang++;
                holdTempDataProgrammingBlockThenPutInArr = StringTrimRight(holdTempDataProgrammingBlockThenPutInArr, 1);
                programmingBlocksTemp += "programmingBlock_InTheTranspiledLang-programmingBlock_InTheTranspiledLang-AA" + STR(COUNT_programmingBlock_InTheTranspiledLang) + "AA" + Chr(10);
            ...
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangEndCPP)) {
                COUNT_programmingBlock_CPP++;
                holdTempDataProgrammingBlockThenPutInArr = StringTrimRight(holdTempDataProgrammingBlockThenPutInArr, 1);
                programmingBlocksTemp += "programmingBlock_CPP-programmingBlock_CPP-AA" + STR(COUNT_programmingBlock_CPP) + "AA" + Chr(10);
            ...
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangEndPY)) {
                COUNT_programmingBlock_PY++;
                holdTempDataProgrammingBlockThenPutInArr = StringTrimRight(holdTempDataProgrammingBlockThenPutInArr, 1);
                programmingBlocksTemp += "programmingBlock_PY-programmingBlock_PY-AA" + STR(COUNT_programmingBlock_PY) + "AA" + Chr(10);
            ...
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangEndJS)) {
                COUNT_programmingBlock_JS++;
                holdTempDataProgrammingBlockThenPutInArr = StringTrimRight(holdTempDataProgrammingBlockThenPutInArr, 1);
                programmingBlocksTemp += "programmingBlock_JS-programmingBlock_JS-AA" + STR(COUNT_programmingBlock_JS) + "AA" + Chr(10);
            ...
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangEndGO)) {
                COUNT_programmingBlock_GO++;
                holdTempDataProgrammingBlockThenPutInArr = StringTrimRight(holdTempDataProgrammingBlockThenPutInArr, 1);
                programmingBlocksTemp += "programmingBlock_GO-programmingBlock_GO-AA" + STR(COUNT_programmingBlock_GO) + "AA" + Chr(10);
            ...
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangEndLUA)) {
                COUNT_programmingBlock_LUA++;
                holdTempDataProgrammingBlockThenPutInArr = StringTrimRight(holdTempDataProgrammingBlockThenPutInArr, 1);
                programmingBlocksTemp += "programmingBlock_LUA-programmingBlock_LUA-AA" + STR(COUNT_programmingBlock_LUA) + "AA" + Chr(10);
            ...
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangEndCS)) {
                COUNT_programmingBlock_CS++;
                holdTempDataProgrammingBlockThenPutInArr = StringTrimRight(holdTempDataProgrammingBlockThenPutInArr, 1);
                programmingBlocksTemp += "programmingBlock_CS-programmingBlock_CS-AA" + STR(COUNT_programmingBlock_CS) + "AA" + Chr(10);
            ...
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangEndJAVA)) {
                COUNT_programmingBlock_JAVA++;
                holdTempDataProgrammingBlockThenPutInArr = StringTrimRight(holdTempDataProgrammingBlockThenPutInArr, 1);
                programmingBlocksTemp += "programmingBlock_JAVA-programmingBlock_JAVA-AA" + STR(COUNT_programmingBlock_JAVA) + "AA" + Chr(10);
            ...
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangEndKT)) {
                COUNT_programmingBlock_KT++;
                holdTempDataProgrammingBlockThenPutInArr = StringTrimRight(holdTempDataProgrammingBlockThenPutInArr, 1);
                programmingBlocksTemp += "programmingBlock_KT-programmingBlock_KT-AA" + STR(COUNT_programmingBlock_KT) + "AA" + Chr(10);
            ...
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangEndRB)) {
                COUNT_programmingBlock_RB++;
                holdTempDataProgrammingBlockThenPutInArr = StringTrimRight(holdTempDataProgrammingBlockThenPutInArr, 1);
                programmingBlocksTemp += "programmingBlock_RB-programmingBlock_RB-AA" + STR(COUNT_programmingBlock_RB) + "AA" + Chr(10);
            ...
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangEndNIM)) {
                COUNT_programmingBlock_NIM++;
                holdTempDataProgrammingBlockThenPutInArr = StringTrimRight(holdTempDataProgrammingBlockThenPutInArr, 1);
                programmingBlocksTemp += "programmingBlock_NIM-programmingBlock_NIM-AA" + STR(COUNT_programmingBlock_NIM) + "AA" + Chr(10);
            ...
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangEndAHK)) {
                COUNT_programmingBlock_AHK++;
                holdTempDataProgrammingBlockThenPutInArr = StringTrimRight(holdTempDataProgrammingBlockThenPutInArr, 1);
                programmingBlocksTemp += "programmingBlock_AHK-programmingBlock_AHK-AA" + STR(COUNT_programmingBlock_AHK) + "AA" + Chr(10);
            ...
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangEndSWIFT)) {
                COUNT_programmingBlock_SWIFT++;
                holdTempDataProgrammingBlockThenPutInArr = StringTrimRight(holdTempDataProgrammingBlockThenPutInArr, 1);
                programmingBlocksTemp += "programmingBlock_SWIFT-programmingBlock_SWIFT-AA" + STR(COUNT_programmingBlock_SWIFT) + "AA" + Chr(10);
            ...
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangEndDART)) {
                COUNT_programmingBlock_DART++;
                holdTempDataProgrammingBlockThenPutInArr = StringTrimRight(holdTempDataProgrammingBlockThenPutInArr, 1);
                programmingBlocksTemp += "programmingBlock_DART-programmingBlock_DART-AA" + STR(COUNT_programmingBlock_DART) + "AA" + Chr(10);
            ...
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangEndTS)) {
                COUNT_programmingBlock_TS++;
                holdTempDataProgrammingBlockThenPutInArr = StringTrimRight(holdTempDataProgrammingBlockThenPutInArr, 1);
                programmingBlocksTemp += "programmingBlock_TS-programmingBlock_TS-AA" + STR(COUNT_programmingBlock_TS) + "AA" + Chr(10);
            ...
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangEndGROOVY)) {
                COUNT_programmingBlock_GROOVY++;
                holdTempDataProgrammingBlockThenPutInArr = StringTrimRight(holdTempDataProgrammingBlockThenPutInArr, 1);
                programmingBlocksTemp += "programmingBlock_GROOVY-programmingBlock_GROOVY-AA" + STR(COUNT_programmingBlock_GROOVY) + "AA" + Chr(10);
            ...
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangEndHTVM)) {
                COUNT_programmingBlock_HTVM++;
                holdTempDataProgrammingBlockThenPutInArr = StringTrimRight(holdTempDataProgrammingBlockThenPutInArr, 1);
                programmingBlocksTemp += "programmingBlock_HTVM-programmingBlock_HTVM-AA" + STR(COUNT_programmingBlock_HTVM) + "AA" + Chr(10);
            ...
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInHTVMend)) {
                //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                COUNT_programmingBlock_HTVMsyntax++;
                holdTempDataProgrammingBlockThenPutInArr = StringTrimRight(holdTempDataProgrammingBlockThenPutInArr, 1);
                ...
                holdTempDataProgrammingBlockThenPutInArr += A_LoopField193 + Chr(10);
            }
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangStart)) {
                holdTempDataProgrammingBlockThenPutInArr = "";
                inProgarmmingBlock = 1;
            }
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangStartCPP)) {
                holdTempDataProgrammingBlockThenPutInArr = "";
                inProgarmmingBlock = 1;
            }
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangStartPY)) {
                holdTempDataProgrammingBlockThenPutInArr = "";
                inProgarmmingBlock = 1;
            }
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangStartJS)) {
                holdTempDataProgrammingBlockThenPutInArr = "";
                inProgarmmingBlock = 1;
            }
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangStartGO)) {
                holdTempDataProgrammingBlockThenPutInArr = "";
                inProgarmmingBlock = 1;
            }
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangStartLUA)) {
                holdTempDataProgrammingBlockThenPutInArr = "";
                inProgarmmingBlock = 1;
            }
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangStartCS)) {
                holdTempDataProgrammingBlockThenPutInArr = "";
                inProgarmmingBlock = 1;
            }
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangStartJAVA)) {
                holdTempDataProgrammingBlockThenPutInArr = "";
                inProgarmmingBlock = 1;
            }
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangStartKT)) {
                holdTempDataProgrammingBlockThenPutInArr = "";
                inProgarmmingBlock = 1;
            }
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangStartRB)) {
                holdTempDataProgrammingBlockThenPutInArr = "";
                inProgarmmingBlock = 1;
            }
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangStartNIM)) {
                holdTempDataProgrammingBlockThenPutInArr = "";
                inProgarmmingBlock = 1;
            }
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangStartAHK)) {
                holdTempDataProgrammingBlockThenPutInArr = "";
                inProgarmmingBlock = 1;
            }
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangStartSWIFT)) {
                holdTempDataProgrammingBlockThenPutInArr = "";
                inProgarmmingBlock = 1;
            }
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangStartDART)) {
                holdTempDataProgrammingBlockThenPutInArr = "";
                inProgarmmingBlock = 1;
            }
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangStartTS)) {
                holdTempDataProgrammingBlockThenPutInArr = "";
                inProgarmmingBlock = 1;
            }
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangStartGROOVY)) {
                holdTempDataProgrammingBlockThenPutInArr = "";
                inProgarmmingBlock = 1;
            }
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInTheTranspiledLangStartHTVM)) {
                holdTempDataProgrammingBlockThenPutInArr = "";
                inProgarmmingBlock = 1;
            }
            else if (Trim(StrLower(A_LoopField193)) == StrLower(keyWordCodeInHTVMstart)) {
                //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                holdTempDataProgrammingBlockThenPutInArr = "";
                inProgarmmingBlock = 1;
                ...
                programmingBlocksTemp += A_LoopField193 + Chr(10);
            }
        }
        code = StringTrimRight(programmingBlocksTemp, 1);
        //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; ----------------
    ...
    if (isNotHTVMfile == 0) {
        ...
        for (let A_Index194 = 0; A_Index194 < items194.length; A_Index194++) {
            ...
            if (SubStr(Trim(A_LoopField194), 1, StrLen(keyWordComment)) == keyWordComment) {
                commentsBugFixHold = StringTrimLeft(Trim(A_LoopField194), StrLen(keyWordComment));
                ...
                for (let A_Index195 = 0; A_Index195 < items195.length; A_Index195++) {
                    ...
                    if (InStr(A_LoopField195, " ") || InStr(A_LoopField195, Chr(9))) {
                        commentsBugFixHold1 = A_LoopField195;
                    } else {
                        break;
                    }
                }
                ...
                commentsBugFixOut += A_LoopField194 + Chr(10);
            }
        }
        ...
        for (let A_Index197 = 0; A_Index197 < items197.length; A_Index197++) {
            ...
            HTVM_Append(getAllCharForTheFurtureSoIcanAddEscapeChar, A_LoopField197);
        }
        ...
        for (let A_Index198 = 0; A_Index198 < items198.length; A_Index198++) {
            ...
            if (A_LoopField198 == keyWordEscpaeChar && getAllCharForTheFurtureSoIcanAddEscapeChar[A_Index198 + 1] == Chr(34)) {
                ...
                if (fixOutFixDoubleQuotesInsideDoubleQuotesFIXok != 1) {
                    OutFixDoubleQuotesInsideDoubleQuotes += A_LoopField198;
                } else {
        ...
        if (keyWordEscpaeChar == Chr(92) && langToConvertTo != langFileExtension_2) {
            ...
            for (let A_Index199 = 0; A_Index199 < items199.length; A_Index199++) {
                ...
                if (areWEinSome34sNum == 1) {
                    if (A_LoopField199 != Chr(34)) {
                        if (A_LoopField199 == keyWordEscpaeChar && langToConvertTo != langFileExtension_2) {
            ...
            for (let A_Index200 = 0; A_Index200 < items200.length; A_Index200++) {
                ...
                if (A_LoopField200 == Chr(34)) {
                    areWEinSome34sNum++;
                }
                if (areWEinSome34sNum == 1) {
                    if (A_LoopField200 != Chr(34)) {
                        if (A_LoopField200 == keyWordEscpaeChar && keyWordEscpaeChar == getAllCharForTheFurtureSoIcanAddEscapeChar[A_Index200 + 1] && langToConvertTo != langFileExtension_2) {
                        ...
                        else if (A_LoopField200 == keyWordEscpaeChar && langToConvertTo != langFileExtension_2) {
                            ...
                            theIdNumOfThe34theVar[theIdNumOfThe34] = theIdNumOfThe34theVar[theIdNumOfThe34] + A_LoopField200;
                        }
                    } else {
                        theIdNumOfThe34++;
                        htCodeOUT754754 += "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(theIdNumOfThe34) + Chr(65) + Chr(65);
                ...
                if (areWEinSome34sNum == 2 || areWEinSome34sNum == 0) {
                    if (A_LoopField200 != Chr(34)) {
                        htCodeOUT754754 += A_LoopField200;
                    }
                    areWEinSome34sNum = 0;
                }
            }
        ...
        for (let A_Index201 = 0; A_Index201 < theIdNumOfThe34; A_Index201++) {
            theIdNumOfThe34theVar[A_Index201] = theIdNumOfThe34theVar[A_Index201] + Chr(34);
        }
        HTVM_Append(theIdNumOfThe34theVar, Chr(34));
        if (langToConvertTo == "dart" || langToConvertTo == "groovy") {
            for (let A_Index202 = 0; A_Index202 < HTVM_Size(theIdNumOfThe34theVar); A_Index202++) {
                theIdNumOfThe34theVar[A_Index202] = StrReplace(theIdNumOfThe34theVar[A_Index202], "$", Chr(92) + "$");
            }
        }
        ...
        for (let A_Index203 = 0; A_Index203 < items203.length; A_Index203++) {
            ...
            if (InStr(A_LoopField203, " " + keyWordComment) != false && SubStr(Trim(A_LoopField203), 1, StrLen(keyWordComment)) != keyWordComment) {
                posForRemoveCommentsOnTheEndOfTheLine = 0;
                slidingWinFixCommentsRmI = 0;
                slidingWinFixCommentsRm = slidingWinFixCommentsRmFUNC(A_LoopField203);
                for (let A_Index204 = 0; A_Index204 < HTVM_Size(slidingWinFixCommentsRm); A_Index204++) {
                    slidingWinFixCommentsRmI = A_Index204;
                    slidingWinFixCommentsRmHold = "";
                    for (let A_Index205 = 0; A_Index205 < StrLen(" " + keyWordComment); A_Index205++) {
                        slidingWinFixCommentsRmHold += slidingWinFixCommentsRm[slidingWinFixCommentsRmI + A_Index205];
                    }
                    if (Trim(slidingWinFixCommentsRmHold) == keyWordComment) {
                        posForRemoveCommentsOnTheEndOfTheLine = A_Index204;
                        break;
                    }
                }
                if (posForRemoveCommentsOnTheEndOfTheLine > 0) {
                    // Keep only the part before the comment
                    newStringOutCode += SubStr(A_LoopField203, 1, posForRemoveCommentsOnTheEndOfTheLine) + Chr(10);
                } else {
                    // Keep the whole line as it is
                    newStringOutCode += A_LoopField203 + Chr(10);
                }
            } else {
                newStringOutCode += A_LoopField203 + Chr(10);
            }
        ...
        if (langToConvertTo != langFileExtension_2) {
            ...
            for (let A_Index206 = 0; A_Index206 < items206.length; A_Index206++) {
                ...
                if (SubStr(Trim(A_LoopField206), 1, 1) != ";") {
                    semiColonForOneLinerOut += StrReplace(A_LoopField206, ";", Chr(10)) + Chr(10);
                } else {
                    semiColonForOneLinerOut += A_LoopField206 + Chr(10);
                }
            }
        ...
        if (useCurlyBraces == "on") {
            ...
            for (let A_Index207 = 0; A_Index207 < items207.length; A_Index207++) {
                ...
                str1 = "";
                if (InStr(A_LoopField207, keyWordCurlyBraceOpen) || InStr(A_LoopField207, keyWordCurlyBraceClose)) {
                    if (SubStr(Trim(A_LoopField207), 1, StrLen(Trim(keyWordComment))) == Trim(keyWordComment) && isLineAconstruct(Trim(A_LoopField207)) == false) {
                        fixSomeCurlyBraceForExratFlexability += A_LoopField207 + Chr(10);
                    } else {
                        if (SubStr(Trim(A_LoopField207), 1, StrLen(Trim(keyWordArrayDefinition) + " ")) == Trim(keyWordArrayDefinition) + " " || SubStr(Trim(A_LoopField207), 1, StrLen(Trim(keyWordArrayOfIntegersDefinition) + " ")) == Trim(keyWordArrayOfIntegersDefinition) + " " || SubStr(Trim(A_LoopField207), 1, StrLen(Trim(keyWordArrayOfStringsDefinition) + " ")) == Trim(keyWordArrayOfStringsDefinition) + " " || SubStr(Trim(A_LoopField207), 1, StrLen(Trim(keyWordArrayOfFloatingPointNumbersDefinition) + " ")) == Trim(keyWordArrayOfFloatingPointNumbersDefinition) + " " || SubStr(Trim(A_LoopField207), 1, StrLen(Trim(keyWordArrayOfBooleansDefinition) + " ")) == Trim(keyWordArrayOfBooleansDefinition) + " " && useCurlyBracesSyntaxForArrayDef == "on") {
                            fixSomeCurlyBraceForExratFlexability += A_LoopField207 + Chr(10);
                        } else {
                            str1 = StrReplace(A_LoopField207, keyWordCurlyBraceOpen, "{");
            ...
            for (let A_Index208 = 0; A_Index208 < items208.length; A_Index208++) {
                ...
                fixSomeCurlyBraceForExratFlexabilityTriHELP += Trim(A_LoopField208) + Chr(10);
            }
            ...
            if (keyWordCurlyBraceOpen != "{") {
                ...
                for (let A_Index209 = 0; A_Index209 < items209.length; A_Index209++) {
                    ...
                    htCodeOutFixINT2 = 0;
                    if (isLineAconstruct(Trim(A_LoopField209)) == true || Trim(A_LoopField209) == keyWordCurlyBraceOpen) {
                        htCodeOutFixINT2 = 1;
                    }
                    htCodeOutFixINT = 0;
                    ...
                    htCodeOutFixINT--;
                    let items211 = LoopParseFunc(A_LoopField209, " ");
                    for (let A_Index211 = 0; A_Index211 < items211.length; A_Index211++) {
                        const A_LoopField211 = items211[A_Index211 - 0];
                        if (htCodeOutFixINT == A_Index211 && htCodeOutFixINT2 == 1) {
                            htCodeOutFixINT2 = 0;
                            htCodeOutFixEnd += HTVMmatchStrRrplace(A_LoopField211, keyWordCurlyBraceOpen, "{") + " ";
                        } else {
            ...
            if (keyWordCurlyBraceClose != "}") {
                ...
                for (let A_Index212 = 0; A_Index212 < items212.length; A_Index212++) {
                    ...
                    htCodeOutFixINT2 = 0;
                    if (isLineAconstruct(Trim(A_LoopField212)) == true || Trim(A_LoopField212) == keyWordCurlyBraceClose) {
                        htCodeOutFixINT2 = 1;
                    }
                    ...
                    for (let A_Index213 = 0; A_Index213 < items213.length; A_Index213++) {
                        ...
                        if (htCodeOutFixINT2 == 1 || Trim(A_LoopField213) == keyWordCurlyBraceClose) {
                            htCodeOutFixINT2 = 0;
                            htCodeOutFixEnd += HTVMmatchStrRrplace(A_LoopField213, keyWordCurlyBraceClose, "}") + " ";
                        } else {
                            htCodeOutFixEnd += A_LoopField213 + " ";
                        }
                    }
                    htCodeOutFixEnd = StringTrimRight(htCodeOutFixEnd, 1);
                    htCodeOutFixEnd += Chr(10);
        ...
        if (useCurlyBraces == "on") {
            ...
            for (let A_Index214 = 0; A_Index214 < items214.length; A_Index214++) {
                ...
                HTVM_Append(addNoCurlyFixWhenNextLineAfterConstructLookAhead, Trim(A_LoopField214));
            }
            ...
            for (let A_Index215 = 0; A_Index215 < items215.length; A_Index215++) {
                ...
                if (isLineAconstruct(Trim(A_LoopField215)) && addNoCurlyFixWhenNextLineAfterConstructLookAhead[A_Index215 + 1] != "{") {
                    int5 = 1;
                    addNoCurlyFixWhenNextLineAfterConstructOut += A_LoopField215 + Chr(10) + "{" + Chr(10);
                } else {
                    if (int5 == 1) {
                        int5 = 0;
                        addNoCurlyFixWhenNextLineAfterConstructOut += A_LoopField215 + Chr(10) + "}" + Chr(10);
                    } else {
                        addNoCurlyFixWhenNextLineAfterConstructOut += A_LoopField215 + Chr(10);
                    }
                }
            }
        ...
        if (useEnd == "on") {
            ...
            for (let A_Index216 = 0; A_Index216 < items216.length; A_Index216++) {
                ...
                if (StrLower(Trim(A_LoopField216)) == StrLower(keyWordEnd)) {
                    htCodeOutFixEnd += "}" + Chr(10);
                }
                else if (SubStr(StrLower(Trim(A_LoopField216)), 1, StrLen(StrLower(keyWordIF))) == StrLower(keyWordIF) && isLineAconstruct(Trim(A_LoopField216)) == true) {
                    htCodeOutFixEnd += A_LoopField216 + Chr(10) + "{" + Chr(10);
                }
                else if (SubStr(StrLower(Trim(A_LoopField216)), 1, StrLen(StrLower(keyWordWhileLoop))) == StrLower(keyWordWhileLoop) && isLineAconstruct(Trim(A_LoopField216)) == true) {
                    htCodeOutFixEnd += A_LoopField216 + Chr(10) + "{" + Chr(10);
                }
                else if (SubStr(StrLower(Trim(A_LoopField216)), 1, StrLen(StrLower(keyWordElseIf))) == StrLower(keyWordElseIf) && isLineAconstruct(Trim(A_LoopField216)) == true) {
                    htCodeOutFixEnd += Chr(10) + "}" + Chr(10) + A_LoopField216 + Chr(10) + "{" + Chr(10);
                }
                else if (SubStr(StrLower(Trim(A_LoopField216)), 1, StrLen(StrLower(keyWordElse))) == StrLower(keyWordElse) && isLineAconstruct(Trim(A_LoopField216)) == true) {
                    htCodeOutFixEnd += Chr(10) + "}" + Chr(10) + A_LoopField216 + Chr(10) + "{" + Chr(10);
                }
                else if (SubStr(StrLower(Trim(A_LoopField216)), 1, StrLen(StrLower(keyWordCatch))) == StrLower(keyWordCatch) && isLineAconstruct(Trim(A_LoopField216)) == true) {
                    htCodeOutFixEnd += Chr(10) + "}" + Chr(10) + A_LoopField216 + Chr(10) + "{" + Chr(10);
                }
                else if (SubStr(StrLower(Trim(A_LoopField216)), 1, StrLen(StrLower(keyWordFinally))) == StrLower(keyWordFinally) && isLineAconstruct(Trim(A_LoopField216)) == true) {
                    htCodeOutFixEnd += Chr(10) + "}" + Chr(10) + A_LoopField216 + Chr(10) + "{" + Chr(10);
                }
                else if (isLineAconstruct(Trim(A_LoopField216)) == true) {
                    htCodeOutFixEnd += A_LoopField216 + Chr(10) + "{" + Chr(10);
                } else {
        ...
        for (let A_Index219 = 0; A_Index219 < 2; A_Index219++) {
            ...
            for (let A_Index220 = 0; A_Index220 < items220.length; A_Index220++) {
                ...
                if (SubStr(Trim(A_LoopField220), 1, StrLen(Trim(keyWordArrayDefinition) + " ")) == Trim(keyWordArrayDefinition) + " " || SubStr(Trim(A_LoopField220), 1, StrLen(Trim(keyWordArrayOfIntegersDefinition) + " ")) == Trim(keyWordArrayOfIntegersDefinition) + " " || SubStr(Trim(A_LoopField220), 1, StrLen(Trim(keyWordArrayOfStringsDefinition) + " ")) == Trim(keyWordArrayOfStringsDefinition) + " " || SubStr(Trim(A_LoopField220), 1, StrLen(Trim(keyWordArrayOfFloatingPointNumbersDefinition) + " ")) == Trim(keyWordArrayOfFloatingPointNumbersDefinition) + " " || SubStr(Trim(A_LoopField220), 1, StrLen(Trim(keyWordArrayOfBooleansDefinition) + " ")) == Trim(keyWordArrayOfBooleansDefinition) + " " && useCurlyBracesSyntaxForArrayDef == "on") {
                    if (SubStr(StrLower(A_LoopField220), 1, StrLen(StrLower(keyWordFunc))) == StrLower(keyWordFunc) || SubStr(StrLower(A_LoopField220), 1, StrLen(StrLower(keyWordAsync) + StrLower(keyWordFunc))) == StrLower(keyWordAsync) + StrLower(keyWordFunc)) {
                        if (InStr(Trim(A_LoopField220), "{") && Trim(A_LoopField220) != "{" && SubStr(Trim(A_LoopField220), 1, StrLen(Trim(keyWordComment))) != Trim(keyWordComment)) {
                            outCodeFixBraces += Trim(StrReplace(Trim(A_LoopField220), "{", "")) + Chr(10) + "{" + Chr(10);
                        }
                        else if (InStr(Trim(A_LoopField220), "}") && Trim(A_LoopField220) != "}" && SubStr(Trim(A_LoopField220), 1, StrLen(Trim(keyWordComment))) != Trim(keyWordComment)) {
                            outCodeFixBraces += "}" + Chr(10) + Trim(StrReplace(Trim(A_LoopField220), "}", "")) + Chr(10);
                        } else {
                            outCodeFixBraces += Trim(A_LoopField220) + Chr(10);
                        }
                    } else {
                        outCodeFixBraces += Trim(A_LoopField220) + Chr(10);
                    }
        ...
        if (usePythonicColonSyntax == "on" || useCurlyBraces == "off" && useEnd == "off") {
            ...
            for (let A_Index221 = 0; A_Index221 < items221.length; A_Index221++) {
                ...
                if (isLineAconstruct(Trim(A_LoopField221)) == true) {
                    htCodeOutFixEnd += StringTrimRight(A_LoopField221, 1) + Chr(10);
                } else {
        ...
        if (isNotHTVMfile2 == 0) {
            ...
            for (let A_Index222 = 0; A_Index222 < items222.length; A_Index222++) {
                ...
                if (StrLower(Trim(A_LoopField222)) == StrLower(keyWordMainLabel)) {
                    didWeUseMainLabel = 1;
                    if (langToConvertTo == langFileExtension_2) {
                    ...
                    codeOutFixAndAddMainFunc += A_LoopField222 + Chr(10);
                }
            }
        ...
        for (let A_Index223 = 0; A_Index223 < items223.length; A_Index223++) {
            ...
            HTVM_Append(lookIntoTheNextLineForFuncWhitNoKeyWord, A_LoopField223);
        }
        ...
        for (let A_Index224 = 0; A_Index224 < items224.length; A_Index224++) {
            ...
            lineDone = 0;
            if (SubStr(A_LoopField224, 1, StrLen(keyWordComment)) == keyWordComment) {
                lineDone = 1;
                str1 = StringTrimLeft(A_LoopField224, StrLen(keyWordComment));
                if (langToConvertTo == langFileExtension_2) {
            ...
            else if (InStr(A_LoopField224, "guiInit(") || InStr(A_LoopField224, "guiAdd(") || InStr(A_LoopField224, "guiAddElement(") || InStr(A_LoopField224, "guiControl(") || InStr(A_LoopField224, "HTVM_init(") || InStr(A_LoopField224, "HTVM_register(") || InStr(A_LoopField224, "HTVM_custom_port(") && lineDone == 0) {
                lineDone = 1;
                if (InStr(A_LoopField224, "HTVM_init(")) {
                    htCode += Trim(A_LoopField224) + Chr(10);
                } else {
                    htCode += Trim(expressionParserTranspiler(Trim(A_LoopField224))) + Chr(10);
                }
            }
            else if (Trim(A_LoopField224) == keyWordCommentOpenMultiLine) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
            ...
            else if (Trim(A_LoopField224) == keyWordCommentCloseMultiLine) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                ...
                lineDone = 1;
                str1 = StrSplit(A_LoopField224, " ", 2);
            ...
            else if (SubStr(StrLower(Trim(A_LoopField224)), 1, StrLen(StrLower(keyWordStruct))) == StrLower(keyWordStruct)) {
                lineDone = 1;
                str0 = Trim(StringTrimLeft(A_LoopField224, StrLen(keyWordStruct)));
                if (langToConvertTo == langFileExtension_2) {
                    htCode += Trim(keyWordStruct_2) + " " + str0 + Chr(10);
                }
            }
            else if (SubStr(StrLower(Trim(A_LoopField224)), 1, StrLen(StrLower(keyWordAlliance))) == StrLower(keyWordAlliance)) {
                lineDone = 1;
                str0 = Trim(StringTrimLeft(A_LoopField224, StrLen(keyWordAlliance)));
                if (langToConvertTo == langFileExtension_2) {
                    htCode += Trim(keyWordAlliance_2) + " " + str0 + Chr(10);
                }
            }
            else if (SubStr(StrLower(Trim(A_LoopField224)), 1, StrLen(StrLower(keyWordCrew))) == StrLower(keyWordCrew)) {
                lineDone = 1;
                str0 = Trim(StringTrimLeft(A_LoopField224, StrLen(keyWordCrew)));
                if (langToConvertTo == langFileExtension_2) {
                    htCode += Trim(keyWordCrew_2) + " " + str0 + Chr(10);
                }
            }
            else if (InStr(A_LoopField224, "[end][end][end][end][end] ")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    htCode += "}" + Chr(10);
                }
            }
            else if (SubStr(StrLower(Trim(A_LoopField224)), 1, StrLen(StrLower(keyWordProp))) == StrLower(keyWordProp)) {
                lineDone = 1;
                str0 = Trim(StringTrimLeft(A_LoopField224, StrLen(keyWordProp)));
            ...
            else if (SubStr(StrLower(Trim(A_LoopField224)), 1, StrLen(StrLower(keyWordProc))) == StrLower(keyWordProc)) {
                lineDone = 1;
                str0 = Trim(StringTrimLeft(A_LoopField224, StrLen(keyWordProc)));
                str1 = Trim(StrSplit(str0, "-----------------------HTVM-OSP-HTVM-OBJ--------------", 1));
                str20 = Trim(StrSplit(str0, "-----------------------HTVM-OSP-HTVM-OBJ--------------", 2));
            ...
            else if (SubStr(StrLower(Trim(A_LoopField224)), 1, StrLen(StrLower(keyWordIF))) == StrLower(keyWordIF) && SubStr(StrLower(Trim(A_LoopField224)), 1, StrLen(StrLower(keyWordElseIf))) != StrLower(keyWordElseIf)) {
                lineDone = 1;
                str1 = Trim(StringTrimLeft(A_LoopField224, StrLen(keyWordIF)));
            ...
            else if (SubStr(StrLower(Trim(A_LoopField224)), 1, StrLen(StrLower(keyWordElseIf))) == StrLower(keyWordElseIf) && SubStr(StrLower(Trim(A_LoopField224)), 1, StrLen(StrLower(keyWordIF))) != StrLower(keyWordIF)) {
                lineDone = 1;
                str1 = Trim(StringTrimLeft(A_LoopField224, StrLen(keyWordElseIf)));
                str1 = Trim(expressionParserTranspiler("(" + str1 + ")"));
                str1 = StringTrimRight(str1, 1);
                str1 = StringTrimLeft(str1, 1);
                if (langToConvertTo == langFileExtension_2) {
            ...
            else if (StrLower(Trim(A_LoopField224)) == StrLower(keyWordElse) || StrLower(Trim(A_LoopField224)) == StrLower(keyWordElse + ":")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    if (usePythonicColonSyntax_2 == "on") {
            ...
            else if (SubStr(StrLower(Trim(A_LoopField224)), 1, StrLen(StrLower(keyWordWhileLoop))) == StrLower(keyWordWhileLoop)) {
                lineDone = 1;
                str1 = Trim(StringTrimLeft(A_LoopField224, StrLen(keyWordWhileLoop)));
                str1 = Trim(expressionParserTranspiler("(" + str1 + ")"));
                str1 = StringTrimRight(str1, 1);
                str1 = StringTrimLeft(str1, 1);
                if (langToConvertTo == langFileExtension_2) {
            ...
            else if (StrLower(Trim(A_LoopField224)) == StrLower(keyWordTry) || StrLower(Trim(A_LoopField224)) == StrLower(keyWordTry + ":")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    if (usePythonicColonSyntax_2 == "on") {
            ...
            else if (SubStr(StrLower(Trim(A_LoopField224)), 1, StrLen(StrLower(keyWordCatch))) == StrLower(keyWordCatch)) {
                lineDone = 1;
                str1 = Trim(StrReplace(StrReplace(StringTrimLeft(A_LoopField224, StrLen(keyWordCatch)), "(", ""), ")", ""));
            ...
            else if (StrLower(Trim(A_LoopField224)) == StrLower(keyWordFinally) || StrLower(Trim(A_LoopField224)) == StrLower(keyWordFinally + ":")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    if (usePythonicColonSyntax_2 == "on") {
            ...
            else if (SubStr(StrLower(Trim(A_LoopField224)), 1, StrLen(StrLower(keyWordThrow))) == StrLower(keyWordThrow)) {
                lineDone = 1;
                str1 = Trim(A_LoopField224);
                if (SubStrLastChars(str1, 1) == ";") {
                    str1 = StringTrimRight(str1, 1);
                }
            ...
            else if (StrLower(A_LoopField224) == StrLower(keyWordBreak) || StrLower(A_LoopField224) == StrLower(keyWordBreak + ";")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    if (useSemicolon_2 == "on") {
            ...
            else if (StrLower(A_LoopField224) == StrLower(Trim(keyWordReturnStatement)) || StrLower(A_LoopField224) == StrLower(Trim(keyWordReturnStatement) + ";")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    if (useSemicolon_2 == "on") {
            ...
            else if (SubStr(Trim(StrLower(A_LoopField224)), 1, StrLen(StrLower(keyWordReturnStatement))) == StrLower(keyWordReturnStatement)) {
                lineDone = 1;
                str1 = Trim(expressionParserTranspiler(Trim(StringTrimLeft(A_LoopField224, StrLen(keyWordReturnStatement)))));
                if (SubStrLastChars(str1, 1) == ";") {
                    str1 = StringTrimRight(str1, 1);
                }
                if (langToConvertTo == langFileExtension_2) {
            ...
            else if (StrLower(A_LoopField224) == StrLower(keyWordContinue) || StrLower(A_LoopField224) == StrLower(keyWordContinue + ";")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    if (useSemicolon_2 == "on") {
            ...
            else if (StrLower(A_LoopField224) == "::" + keyWordContinue || StrLower(A_LoopField224) == "::" + keyWordContinue + ";") {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    htCode += "::" + keyWordContinue_2 + Chr(10);
                }
            ...
            else if (StrLower(A_LoopField224) == StrLower(keyWordLoopInfinite) || StrLower(A_LoopField224) == StrLower(keyWordLoopInfinite + ":")) {
                // infinity loops
            ...
            else if (SubStr(Trim(StrLower(A_LoopField224)), 1, StrLen(StrLower(keyWordLoop))) == StrLower(keyWordLoop) && SubStr(Trim(StrLower(A_LoopField224)), 1, StrLen(StrLower(keyWordLoop)) + 2) != StrLower(keyWordLoop) + "% " && SubStr(Trim(StrLower(A_LoopField224)), 1, StrLen(StrLower(keyWordLoopParse))) != StrLower(keyWordLoopParse)) {
                out2 = StringTrimLeft(A_LoopField224, StrLen(keyWordLoop));
            ...
            else if (SubStr(Trim(StrLower(A_LoopField224)), 1, StrLen(StrLower(keyWordLoop)) + 2) == StrLower(keyWordLoop) + "% ") {
                howMany_fixAindexInGoUnused++;
                out2 = StringTrimLeft(A_LoopField224, StrLen(keyWordLoop) + 2);
                out2 = StrReplace(out2, ":", "");
                //MsgBox % out2
                //MsgBox, % out2
                out2 = Trim(out2);
            ...
            else if (SubStr(StrLower(A_LoopField224), 1, StrLen(StrLower(keyWordLoopParse))) == StrLower(keyWordLoopParse)) {
                howMany_fixAindexInGoUnused++;
                var1 = StringTrimLeft(A_LoopField224, StrLen(keyWordLoopParse));
                out2 = StrReplace(out2, ":", "");
                lineDone = 1;
            ...
            else if (SubStrLastChars(Trim(A_LoopField224), StrLen(keyWordInc)) == keyWordInc || SubStrLastChars(Trim(A_LoopField224), StrLen(keyWordInc + ";")) == keyWordInc + ";" && lineDone == 0) {
                if (useSemicolon == "on" || SubStrLastChars(Trim(A_LoopField224), 1) == ";") {
                    str1 = Trim(StringTrimRight(Trim(A_LoopField224), StrLen(keyWordInc + ";")));
                } else {
                    str1 = Trim(StringTrimRight(Trim(A_LoopField224), StrLen(keyWordInc)));
                }
                str1 = Trim(expressionParserTranspiler(str1));
            ...
            else if (SubStrLastChars(Trim(A_LoopField224), StrLen(keyWordDec)) == keyWordDec || SubStrLastChars(Trim(A_LoopField224), StrLen(keyWordDec + ";")) == keyWordDec + ";" && lineDone == 0) {
                if (useSemicolon == "on" || SubStrLastChars(Trim(A_LoopField224), 1) == ";") {
                    str1 = Trim(StringTrimRight(Trim(A_LoopField224), StrLen(keyWordDec + ";")));
                } else {
                    str1 = Trim(StringTrimRight(Trim(A_LoopField224), StrLen(keyWordDec)));
                }
                str1 = Trim(expressionParserTranspiler(str1));
            ...
            else if (SubStr(StrLower(Trim(A_LoopField224)), 1, StrLen(StrLower(keyWordInclude + " "))) == StrLower(keyWordInclude + " ") && langToConvertTo == langFileExtension_2) {
                htCode += keyWordInclude_2 + " " + Trim(StringTrimLeft(Trim(A_LoopField224), StrLen(StrLower(keyWordInclude) + " "))) + Chr(10);
            }
            else if (StrLower(A_LoopField224) == StrLower(keyWordGlobal) || StrLower(A_LoopField224) == StrLower(keyWordGlobal + ";")) {
                if (langToConvertTo == "ahk") {
                    htCode += "global" + Chr(10);
                }
            }
            else if (SubStr(StrLower(A_LoopField224), 1, StrLen(StrLower(keyWordAwait))) == StrLower(keyWordAwait)) {
                str1 = StringTrimLeft(A_LoopField224, StrLen(keyWordAwait));
                //MsgBox, % A_LoopField
                lineDone = 1;
            ...
            else if (SubStr(StrLower(A_LoopField224), 1, StrLen(StrLower(keyWordGlobal))) == StrLower(keyWordGlobal)) {
                str1 = StringTrimLeft(A_LoopField224, StrLen(keyWordGlobal));
                //MsgBox, % A_LoopField
            ...
            else if (SubStr(StrLower(A_LoopField224), 1, StrLen(keyWordFunc)) == StrLower(keyWordFunc) || SubStr(StrLower(A_LoopField224), 1, StrLen(StrLower(keyWordAsync) + StrLower(keyWordFunc))) == StrLower(keyWordAsync) + StrLower(keyWordFunc) && InStr(StrLower(A_LoopField224), " main(") == false && lineDone == 0) {
                lineDone = 1;
                if (SubStr(StrLower(A_LoopField224), 1, StrLen(StrLower(keyWordAsync) + StrLower(keyWordFunc))) == StrLower(keyWordAsync) + StrLower(keyWordFunc)) {
                    // is async
                    int1 = 1;
                    str1 = Trim(StringTrimLeft(A_LoopField224, StrLen(StrLower(keyWordAsync + keyWordFunc))));
                } else {
                    // is async
                    int1 = 0;
                    str1 = Trim(StringTrimLeft(A_LoopField224, StrLen(StrLower(keyWordFunc))));
                }
                if (langToConvertTo != langFileExtension_2 && langToConvertTo != "cpp" && langToConvertTo != "go" && langToConvertTo != "cs" && langToConvertTo != "java" && langToConvertTo != "kt" && langToConvertTo != "nim" && langToConvertTo != "swift" && langToConvertTo != "dart" && langToConvertTo != "ts") {
                    if (str1 != "") {
                        ...
                        for (let A_Index226 = 0; A_Index226 < items226.length; A_Index226++) {
                            ...
                            if (InStr(A_LoopField226, " = ")) {
                                if (InStr(Trim(StrSplit(A_LoopField226, " = ", 1)), " ") != true) {
                                    str4 += "optanal-HTVM-opt-parmsNOtWorking-theirewIs-a-bug-Iusfbudfbuoeshfuisbav=-fwaegs-awedsf-dd-sfgc " + A_LoopField226 + ", ";
                                } else {
                                    str4 += A_LoopField226 + ", ";
                                }
                            }
                            else if (InStr(A_LoopField226, " " + Trim(keyWordAssign) + " ")) {
                                if (InStr(Trim(StrSplit(A_LoopField226, " " + Trim(keyWordAssign) + " ", 1)), " ") != true) {
                                    str4 += "optanal-HTVM-opt-parmsNOtWorking-theirewIs-a-bug-Iusfbudfbuoeshfuisbav=-fwaegs-awedsf-dd-sfgc " + A_LoopField226 + ", ";
                                } else {
                                    str4 += A_LoopField226 + ", ";
                                }
                ...
                if (Trim(str1) == "") {
                    ...
                    for (let A_Index227 = 0; A_Index227 < items227.length; A_Index227++) {
                        ...
                        if (InStr(Trim(A_LoopField227), " ")) {
                            // there is space aka there is a type
                            if (InStr(A_LoopField227, " " + Trim(keyWordAssign) + " ") == false) {
                                if (usePrefixTypeForTypeDefinition == "on") {
                                    // normal
                                    str6 = Trim(A_LoopField227);
                                ...
                                // optanal param
                                if (InStr(Trim(StrSplit(Trim(A_LoopField227), " " + Trim(keyWordAssign) + " ", 1)), " ")) {
                                    // there is a type
                                    if (usePrefixTypeForTypeDefinition == "on") {
                                        // normal
                                        str6 = Trim(StrSplit(Trim(A_LoopField227), " " + Trim(keyWordAssign) + " ", 1));
                                        str9 = Trim(expressionParserTranspiler(Trim(StrSplit(Trim(A_LoopField227), " " + Trim(keyWordAssign) + " ", 2))));
                                        str7 = getTheLastWord(str6);
                                        str8 = getFuncTypeConvert(Trim(StringTrimRight(str6, StrLen(Trim(str7)) + 1)));
                                        //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                        //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    ...
                                    // there is no type
                                    str8 = Trim(StrSplit(Trim(A_LoopField227), " " + Trim(keyWordAssign) + " ", 1));
                                    str9 = Trim(expressionParserTranspiler(Trim(StrSplit(Trim(A_LoopField227), " " + Trim(keyWordAssign) + " ", 2))));
                                    // str10
                                    // skipLeftCuleyForFuncPLS := 1
                                    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            str5 += Trim(A_LoopField227) + Chr(10);
                        }
                    }
                    //print(str5)
                    //print(str10)
                    ...
                    if (Trim(str5) != "" && Trim(str10) != "") {
                        ...
                        if (langToConvertTo == "lua") {
                            ...
                            for (let A_Index230 = 0; A_Index230 < items230.length; A_Index230++) {
                                ...
                                str14 += Trim(StrSplit(Trim(A_LoopField230), " = ", 1)) + ", ";
                            }
                            ...
                            for (let A_Index231 = 0; A_Index231 < items231.length; A_Index231++) {
                                ...
                                str13 += Trim(StrSplit(Trim(A_LoopField231), " = ", 1)) + " = " + Trim(StrSplit(Trim(A_LoopField231), " = ", 1)) + " or " + Trim(StrSplit(Trim(A_LoopField231), " = ", 2)) + Chr(10);
                            }
                            str12 = str14;
                        }
                        if (langToConvertTo == "go") {
                            ...
                            for (let A_Index232 = 0; A_Index232 < items232.length; A_Index232++) {
                                ...
                                str17 = Trim(StrSplit(Trim(A_LoopField232), " = ", 2));
                            ...
                            for (let A_Index233 = 0; A_Index233 < items233.length; A_Index233++) {
                                ...
                                str16 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField233), " = ", 1)), " ", 1));
                                str18 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField233), " = ", 1)), " ", 2));
                                // str16 = var name
                                // str18 = var type
                                str13 += "if len(__HTVM_V2_TO_GO_optionalParams__) " + Chr(62) + " " + STR(A_Index233) + Chr(10) + "{" + Chr(10) + str16 + " = __HTVM_V2_TO_GO_optionalParams__[" + STR(A_Index233) + "].(" + str18 + ")" + Chr(10) + "}" + Chr(10);
                            }
                            str12 = str14;
                        }
                        if (langToConvertTo == "java") {
                            ...
                            for (let A_Index234 = 0; A_Index234 < items234.length; A_Index234++) {
                                ...
                                str19 = Trim(A_LoopField234);
                                str20 = "";
                                let items235 = LoopParseFunc(str19, " ");
                                for (let A_Index235 = 0; A_Index235 < items235.length; A_Index235++) {
                                    const A_LoopField235 = items235[A_Index235 - 0];
                                    if (A_Index235 == 3) {
                                        if (RegExMatch(A_LoopField235, "^-?\\d+(\\.\\d+)?$")) {
                                            str20 += A_LoopField235 + "f ";
                                        } else {
                                            str20 += A_LoopField235 + " ";
                                        }
                                    } else {
                                        str20 += A_LoopField235 + " ";
                                    }
                            ...
                            for (let A_Index236 = 0; A_Index236 < items236.length; A_Index236++) {
                                ...
                                str16 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField236), " = ", 1)), " ", 2));
                                str17 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField236), " = ", 1)), " ", 1));
                                // str16 = var name
                                // str17 = type name
                                str13 += "if (__HTVM_V2_TO_JAVA_optionalParams__.length " + Chr(62) + " " + STR(A_Index236) + ") " + str16 + " = (" + str17 + ") __HTVM_V2_TO_JAVA_optionalParams__[" + STR(A_Index236) + "];" + Chr(10);
                            }
                            str12 = str14;
                        }
                        str11 += str12;
                    ...
                    if (Trim(str5) != "" && Trim(str10) == "") {
                        let items237 = LoopParseFunc(str5, "\n", "\r");
                    ...
                    if (Trim(str5) == "" && Trim(str10) != "") {
                        let items238 = LoopParseFunc(str10, "\n", "\r");
                        ...
                        if (langToConvertTo == "lua") {
                            ...
                            for (let A_Index239 = 0; A_Index239 < items239.length; A_Index239++) {
                                ...
                                str14 += Trim(StrSplit(Trim(A_LoopField239), " = ", 1)) + ", ";
                            }
                            str14 = StringTrimRight(str14, 2);
                            str13 += "{" + Chr(10);
                            ...
                            for (let A_Index240 = 0; A_Index240 < items240.length; A_Index240++) {
                                ...
                                str13 += Trim(StrSplit(Trim(A_LoopField240), " = ", 1)) + " = " + Trim(StrSplit(Trim(A_LoopField240), " = ", 1)) + " or " + Trim(StrSplit(Trim(A_LoopField240), " = ", 2)) + Chr(10);
                            }
                            str11 = str14;
                        }
                        if (langToConvertTo == "go") {
                            ...
                            for (let A_Index241 = 0; A_Index241 < items241.length; A_Index241++) {
                                ...
                                str17 = Trim(StrSplit(Trim(A_LoopField241), " = ", 2));
                                str13 += str16 + " := " + str17 + Chr(10);
                            }
                            ...
                            for (let A_Index242 = 0; A_Index242 < items242.length; A_Index242++) {
                                ...
                                str18 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField242), " = ", 1)), " ", 2));
                                // str16 = var name
                                // str18 = var type
                                str13 += "if len(__HTVM_V2_TO_GO_optionalParams__) " + Chr(62) + " " + STR(A_Index242) + Chr(10) + "{" + Chr(10) + str16 + " = __HTVM_V2_TO_GO_optionalParams__[" + STR(A_Index242) + "].(" + str18 + ")" + Chr(10) + "}" + Chr(10);
                            }
                            str11 = str14;
                        }
                        if (langToConvertTo == "java") {
                            ...
                            for (let A_Index243 = 0; A_Index243 < items243.length; A_Index243++) {
                                ...
                                str19 = Trim(A_LoopField243);
                                str20 = "";
                                let items244 = LoopParseFunc(str19, " ");
                                for (let A_Index244 = 0; A_Index244 < items244.length; A_Index244++) {
                                    const A_LoopField244 = items244[A_Index244 - 0];
                                    if (A_Index244 == 3) {
                                        if (RegExMatch(A_LoopField244, "^-?\\d+(\\.\\d+)?$")) {
                                            str20 += A_LoopField244 + "f ";
                                        } else {
                                            str20 += A_LoopField244 + " ";
                                        }
                                    } else {
                                        str20 += A_LoopField244 + " ";
                                    }
                            ...
                            for (let A_Index245 = 0; A_Index245 < items245.length; A_Index245++) {
                                ...
                                str16 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField245), " = ", 1)), " ", 2));
                                str17 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField245), " = ", 1)), " ", 1));
                                // str16 = var name
                                // str17 = type name
                                str13 += "if (__HTVM_V2_TO_JAVA_optionalParams__.length " + Chr(62) + " " + STR(A_Index245) + ") " + str16 + " = (" + str17 + ") __HTVM_V2_TO_JAVA_optionalParams__[" + STR(A_Index245) + "];" + Chr(10);
                            }
                            str11 = str14;
                        }
                    }
            ...
            else if (InStr(StrLower(A_LoopField224), " main(") && lineDone == 0) {
                lineDone = 1;
                javaMainFuncSeen = 1;
                csMainFuncSeen = 1;
                htCode += A_LoopField224 + Chr(10);
            }
            else if (InStr(A_LoopField224, " " + keyWordAssign + " ") || InStr(A_LoopField224, " " + keyWordAssignAdd + " ") || InStr(A_LoopField224, " " + keyWordAssignConcat + " ") || InStr(A_LoopField224, " " + keyWordAssignSub + " ") || InStr(A_LoopField224, " " + keyWordAssignMul + " ") || InStr(A_LoopField224, " " + keyWordAssignDiv + " ") || InStr(A_LoopField224, " " + keyWordAssignMod + " ") || InStr(A_LoopField224, " " + keyWordAssignShiftLeft + " ") || InStr(A_LoopField224, " " + keyWordAssignShiftRight + " ") || InStr(A_LoopField224, " " + keyWordLogicalAssignShiftRight + " ") || InStr(A_LoopField224, " " + keyWordAssignBitAnd + " ") || InStr(A_LoopField224, " " + keyWordAssignBitOr + " ") || InStr(A_LoopField224, " " + keyWordAssignBitXor + " ") && lineDone == 0) {
                allVarsSoWeDontReDecVars_FIX_TOGGLE = 1;
                //keyWordAssign
                //keyWordAssignAdd
                //keyWordAssignConcat
                ...
                //allVarsSoWeDontReDecVars_FIX_int64
                //allVarsSoWeDontReDecVars_FIX_float
                if (InStr(A_LoopField224, " " + keyWordAssign + " ")) {
                    str1 = StrSplit(A_LoopField224, " " + keyWordAssign + " ", 1);
                    str6 = StrSplit(A_LoopField224, " " + keyWordAssign + " ", 2);
                    str10 = keyWordAssign;
                    str11 = keyWordAssign_2;
                    if (langToConvertTo == "ahk") {
                        str12 = ":=";
                ...
                else if (InStr(A_LoopField224, " " + keyWordAssignAdd + " ")) {
                    str1 = StrSplit(A_LoopField224, " " + keyWordAssignAdd + " ", 1);
                    str6 = StrSplit(A_LoopField224, " " + keyWordAssignAdd + " ", 2);
                    str10 = keyWordAssignAdd;
                    str11 = keyWordAssignAdd_2;
                    str12 = "+=";
                }
                else if (InStr(A_LoopField224, " " + keyWordAssignConcat + " ")) {
                    str1 = StrSplit(A_LoopField224, " " + keyWordAssignConcat + " ", 1);
                    str6 = StrSplit(A_LoopField224, " " + keyWordAssignConcat + " ", 2);
                    str10 = keyWordAssignConcat;
                    str11 = keyWordAssignConcat_2;
                    if (langToConvertTo == "ahk") {
                        str12 = ".=";
                ...
                else if (InStr(A_LoopField224, " " + keyWordAssignSub + " ")) {
                    str1 = StrSplit(A_LoopField224, " " + keyWordAssignSub + " ", 1);
                    str6 = StrSplit(A_LoopField224, " " + keyWordAssignSub + " ", 2);
                    str10 = keyWordAssignSub;
                    str11 = keyWordAssignSub_2;
                    str12 = "-=";
                }
                else if (InStr(A_LoopField224, " " + keyWordAssignMul + " ")) {
                    str1 = StrSplit(A_LoopField224, " " + keyWordAssignMul + " ", 1);
                    str6 = StrSplit(A_LoopField224, " " + keyWordAssignMul + " ", 2);
                    str10 = keyWordAssignMul;
                    str11 = keyWordAssignMul_2;
                    str12 = "*=";
                }
                else if (InStr(A_LoopField224, " " + keyWordAssignDiv + " ")) {
                    str1 = StrSplit(A_LoopField224, " " + keyWordAssignDiv + " ", 1);
                    str6 = StrSplit(A_LoopField224, " " + keyWordAssignDiv + " ", 2);
                    str10 = keyWordAssignDiv;
                    str11 = keyWordAssignDiv_2;
                    str12 = "/=";
                }
                else if (InStr(A_LoopField224, " " + keyWordAssignMod + " ")) {
                    str1 = StrSplit(A_LoopField224, " " + keyWordAssignMod + " ", 1);
                    str6 = StrSplit(A_LoopField224, " " + keyWordAssignMod + " ", 2);
                    str10 = keyWordAssignMod;
                    str11 = keyWordAssignMod_2;
                    str12 = "%=";
                }
                else if (InStr(A_LoopField224, " " + keyWordAssignShiftLeft + " ")) {
                    str1 = StrSplit(A_LoopField224, " " + keyWordAssignShiftLeft + " ", 1);
                    str6 = StrSplit(A_LoopField224, " " + keyWordAssignShiftLeft + " ", 2);
                    str10 = keyWordAssignShiftLeft;
                    str11 = keyWordAssignShiftLeft_2;
                    str12 = "<<=";
                }
                else if (InStr(A_LoopField224, " " + keyWordAssignShiftRight + " ")) {
                    str1 = StrSplit(A_LoopField224, " " + keyWordAssignShiftRight + " ", 1);
                    str6 = StrSplit(A_LoopField224, " " + keyWordAssignShiftRight + " ", 2);
                    str10 = keyWordAssignShiftRight;
                    str11 = keyWordAssignShiftRight_2;
                    str12 = ">>=";
                }
                else if (InStr(A_LoopField224, " " + keyWordLogicalAssignShiftRight + " ")) {
                    str1 = StrSplit(A_LoopField224, " " + keyWordLogicalAssignShiftRight + " ", 1);
                    str6 = StrSplit(A_LoopField224, " " + keyWordLogicalAssignShiftRight + " ", 2);
                    str10 = keyWordLogicalAssignShiftRight;
                    str11 = keyWordLogicalAssignShiftRight_2;
                    str12 = ">>>=";
                }
                else if (InStr(A_LoopField224, " " + keyWordAssignBitAnd + " ")) {
                    str1 = StrSplit(A_LoopField224, " " + keyWordAssignBitAnd + " ", 1);
                    str6 = StrSplit(A_LoopField224, " " + keyWordAssignBitAnd + " ", 2);
                    str10 = keyWordAssignBitAnd;
                    str11 = keyWordAssignBitAnd_2;
                    str12 = "&=";
                }
                else if (InStr(A_LoopField224, " " + keyWordAssignBitOr + " ")) {
                    str1 = StrSplit(A_LoopField224, " " + keyWordAssignBitOr + " ", 1);
                    str6 = StrSplit(A_LoopField224, " " + keyWordAssignBitOr + " ", 2);
                    str10 = keyWordAssignBitOr;
                    str11 = keyWordAssignBitOr_2;
                    str12 = "|=";
                }
                else if (InStr(A_LoopField224, " " + keyWordAssignBitXor + " ")) {
                    str1 = StrSplit(A_LoopField224, " " + keyWordAssignBitXor + " ", 1);
                    str6 = StrSplit(A_LoopField224, " " + keyWordAssignBitXor + " ", 2);
                    str10 = keyWordAssignBitXor;
                    str11 = keyWordAssignBitXor_2;
                    str12 = "^=";
                }
            ...
            else if (SubStr(Trim(A_LoopField224), 1, StrLen(keyWordVar)) == keyWordVar && lineDone == 0) {
                allVarsSoWeDontReDecVars_FIX_TOGGLE = 1;
                if (usePostfixTypeForTypeDefinition == "off") {
                    lineDone = 1;
                    str1 = Trim(StringTrimLeft(Trim(A_LoopField224), StrLen(keyWordVar)));
                    if (SubStrLastChars(str1, 1) == ";") {
                        str1 = StringTrimRight(str1, 1);
                    }
            ...
            else if (SubStr(Trim(A_LoopField224), 1, StrLen(keyWordLet)) == keyWordLet && lineDone == 0) {
                allVarsSoWeDontReDecVars_FIX_TOGGLE = 1;
                if (usePostfixTypeForTypeDefinition == "off") {
                    lineDone = 1;
                    str1 = Trim(StringTrimLeft(Trim(A_LoopField224), StrLen(keyWordLet)));
                    if (SubStrLastChars(str1, 1) == ";") {
                        str1 = StringTrimRight(str1, 1);
                    }
            ...
            else if (SubStr(Trim(A_LoopField224), 1, StrLen(keyWordDouble + " ")) == keyWordDouble + " " || SubStr(Trim(A_LoopField224), 1, StrLen(keyWordChar + " ")) == keyWordChar + " " || SubStr(Trim(A_LoopField224), 1, StrLen(keyWordUint8 + " ")) == keyWordUint8 + " " || SubStr(Trim(A_LoopField224), 1, StrLen(keyWordUint16 + " ")) == keyWordUint16 + " " || SubStr(Trim(A_LoopField224), 1, StrLen(keyWordUint32 + " ")) == keyWordUint32 + " " || SubStr(Trim(A_LoopField224), 1, StrLen(keyWordUint64 + " ")) == keyWordUint64 + " " || SubStr(Trim(A_LoopField224), 1, StrLen(keyWordINT + " ")) == keyWordINT + " " || SubStr(Trim(A_LoopField224), 1, StrLen(keyWordSTR + " ")) == keyWordSTR + " " || SubStr(Trim(A_LoopField224), 1, StrLen(keyWordBOOL + " ")) == keyWordBOOL + " " || SubStr(Trim(A_LoopField224), 1, StrLen(keyWordFLOAT + " ")) == keyWordFLOAT + " " || SubStr(Trim(A_LoopField224), 1, StrLen(keyWordINT8 + " ")) == keyWordINT8 + " " || SubStr(Trim(A_LoopField224), 1, StrLen(keyWordINT16 + " ")) == keyWordINT16 + " " || SubStr(Trim(A_LoopField224), 1, StrLen(keyWordINT32 + " ")) == keyWordINT32 + " " || SubStr(Trim(A_LoopField224), 1, StrLen(keyWordINT64 + " ")) == keyWordINT64 + " " || SubStr(Trim(A_LoopField224), 1, StrLen(keyWordArrayDefinition + " ")) == keyWordArrayDefinition + " " || SubStr(Trim(A_LoopField224), 1, StrLen(keyWordArrayOfIntegersDefinition + " ")) == keyWordArrayOfIntegersDefinition + " " || SubStr(Trim(A_LoopField224), 1, StrLen(keyWordArrayOfStringsDefinition + " ")) == keyWordArrayOfStringsDefinition + " " || SubStr(Trim(A_LoopField224), 1, StrLen(keyWordArrayOfFloatingPointNumbersDefinition + " ")) == keyWordArrayOfFloatingPointNumbersDefinition + " " || SubStr(Trim(A_LoopField224), 1, StrLen(keyWordArrayOfBooleansDefinition + " ")) == keyWordArrayOfBooleansDefinition + " " && usePrefixTypeForTypeDefinition == "on" && lineDone == 0) {
                lineDone = 1;
                allVarsSoWeDontReDecVars_FIX_TOGGLE = 1;
                str1 = Trim(A_LoopField224);
                if (SubStrLastChars(str1, 1) == ";") {
            ...
            else if (RegExMatch(Trim(A_LoopField224), "^[a-zA-Z_][a-zA-Z0-9_]*: [^:]*;?$") && usePostfixTypeForTypeDefinition == "on" && lineDone == 0) {
                lineDone = 1;
                allVarsSoWeDontReDecVars_FIX_TOGGLE = 1;
                str1 = Trim(A_LoopField224);
                if (SubStrLastChars(str1, 1) == ";") {
            ...
            else if (RegExMatch(Trim(A_LoopField224), "^[a-zA-Z0-9_\\.]+\\(") && !(InStr(StrLower(A_LoopField224), " main(")) && lineDone == 0) {
                lineDone = 1;
                str1 = Trim(A_LoopField224);
                if (SubStrLastChars(str1, 1) == ";") {
                    str1 = StringTrimRight(str1, 1);
            ...
            else if (RegExMatch(A_LoopField224, "\\.[a-zA-Z_][a-zA-Z0-9_]*") && lineDone == 0) {
                lineDone = 1;
                str1 = Trim(A_LoopField224);
                if (SubStrLastChars(str1, 1) == ";") {
                    str1 = StringTrimRight(str1, 1);
            ...
            else if (KeyWordsCommands(A_LoopField224, "check", commands, langToConvertTo) == "true" && lineDone == 0) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    htCode += A_LoopField224 + Chr(10);
                } else {
                    out_KeyWordsCommands = KeyWordsCommands(A_LoopField224, "transpile", commands, langToConvertTo);
                ...
                if (lineDone != 1) {
                    if (skipLeftCuleyForFuncPLS != 1) {
                        if (SubStr(Trim(StrLower(A_LoopField224)), 1, 1) == Chr(125)) {
                            htCode += Chr(125) + Chr(10);
                        } else {
                            if (htCodeAcurlyBraceAddSomeVrasFixLP == 1 && SubStr(Trim(StrLower(A_LoopField224)), 1, 1) == Chr(123)) {
                                htCodeAcurlyBraceAddSomeVrasFixLP = 0;
                                htCode += A_LoopField224 + Chr(10) + theFixTextLoopLP + Chr(10);
                            } else {
                                if (htCodeAcurlyBraceAddSomeVrasFixNL == 1 && SubStr(Trim(StrLower(A_LoopField224)), 1, 1) == Chr(123)) {
                                    htCodeAcurlyBraceAddSomeVrasFixNL = 0;
                                    htCode += A_LoopField224 + Chr(10) + theFixTextLoopNL + Chr(10);
                                } else {
                                    htCode += A_LoopField224 + Chr(10);
                                }
                            }
        ...
        if (langToConvertTo != "ahk" && langToConvertTo != langFileExtension_2) {
            ...
            if (haveWeEverUsedAloop == 1) {
                ...
                for (let A_Index253 = 0; A_Index253 < items253.length; A_Index253++) {
                    ...
                    if (out1 == "nl") {
                        ...
                        for (let A_Index255 = 0; A_Index255 < items255.length; A_Index255++) {
                            ...
                            if (InStr(A_LoopField255 , fixLoopLokingFor) && insdeAnestedLoopBAD != 1) {
                                fixLoopLokingForNum = 1;
                                //MsgBox, do we came here 3
                            }
                            if (SubStr(Trim(A_LoopField255), 1, 4) == "for " && weAreDoneHereCurly != 1 && insdeAnestedLoopBAD != 1 && fixLoopLokingForNum == 1) {
                                s = StrSplit(A_LoopField255 ,"" + keyWordAIndex + "", 2);
                                out1z = s;
                                s = StrSplit(out1z, " ", 1);
                                ...
                                //MsgBox, % A_LoopField
                                dontSaveStr = 1;
                                ALoopField = A_LoopField255;
                                DeleayOneCuzOfLoopParse = 1;
                                out4758686d86d86d86578991a += ALoopField + Chr(10);
                            }
                            if (inTarget == 1 && InStr(A_LoopField255, Chr(123)) && insdeAnestedLoopBAD != 1) {
                                insideBracket = 1;
                            }
                            if (insideBracket == 1 && InStr(A_LoopField255, Chr(123)) && insdeAnestedLoopBAD != 1) {
                                netsedCurly++;
                            }
                            if (insideBracket == 1 && InStr(A_LoopField255, Chr(125)) && insdeAnestedLoopBAD != 1) {
                                netsedCurly--;
                                readyToEnd = 1;
                            }
                            if (SubStr(Trim(A_LoopField255), 1, 4) == "for " && insdeAnestedLoopBAD != 1 && foundTheTopLoop >= 2) {
                                insdeAnestedLoopBAD = 1;
                                insideBracket1 = 0;
                                netsedCurly1 = 0;
                            }
                            ...
                            if (insdeAnestedLoopBAD == 1) {
                                if (InStr(A_LoopField255, Chr(123))) {
                                    insideBracket1 = 1;
                                }
                                if (insideBracket1 == 1 && InStr(A_LoopField255, Chr(123))) {
                                    netsedCurly1++;
                                }
                                if (insideBracket1 == 1 && InStr(A_LoopField255, Chr(125))) {
                                    netsedCurly1--;
                                    readyToEnd1 = 1;
                                }
                                if (InStr(A_LoopField255, Chr(125)) && readyToEnd1 == 1 && netsedCurly1 == 0 && insideBracket == 1) {
                                    //MsgBox, % A_LoopField
                                    eldLoopNestedBADlol = 1;
                                }
                                out4758686d86d86d86578991a += A_LoopField255 + Chr(10);
                            }
                            if (inTarget == 1 && dontSaveStr != 1 && fixLoopLokingForNum != 1 && insdeAnestedLoopBAD != 1) {
                                ALoopField = A_LoopField255;
                                // Replace "A_Index" with or without a following digit with "A_Index" + out1z
                            ...
                            if ((inTarget == 1 && InStr(A_LoopField255, Chr(125)) && readyToEnd == 1 && netsedCurly == 0 && weAreDoneHereCurly == 0 && dontSaveStr != 1 && insdeAnestedLoopBAD != 1)) {
                                //MsgBox, % A_LoopField
                                weAreDoneHereCurly = 1;
                                inTarget = 0;
                                endBracketDOntPutThere = 1;
                ...
                for (let A_Index256 = 0; A_Index256 < items256.length; A_Index256++) {
                    ...
                    ignore = 0;
                    if (SubStr(Trim(A_LoopField256), 1, 4) == "for ") {
                        if (hold == 1 && holdText == A_LoopField256) {
                            ignore = 1;
                        } else {
                            holdText = A_LoopField256;
                            hold = 1;
                        }
                    }
                    if (!ignore) {
                        out4758686d86dgt8r754444444 += A_LoopField256 + Chr(10);
                    }
                }
    ...
    if (COUNT_programmingBlock_HTVMsyntax != 0) {
        ...
        for (let A_Index258 = 0; A_Index258 < COUNT_programmingBlock_HTVMsyntax; A_Index258++) {
            ADD_ALL_programmingBlock_HTVMsyntax += programmingBlock_HTVMsyntax[A_Index258] + Chr(10);
        }
        ...
        isNotHTVMfile2 = 1;
        for (let A_Index259 = 0; A_Index259 < COUNT_programmingBlock_HTVMsyntax; A_Index259++) {
            htCode = StrReplace(htCode, "programmingBlock_HTVMsyntax-programmingBlock_HTVMsyntax-AA" + STR(A_Index259 + 1) + "AA", compiler(programmingBlock_HTVMsyntax[A_Index259], allInstructionFile, "full", langToConvertToParam));
        }
        isNotHTVMfile2 = 0;
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (langToConvertTo == langFileExtension_2) {
        ...
        if (useEnd_2 == "on") {
            ...
            for (let A_Index260 = 0; A_Index260 < items260.length; A_Index260++) {
                ...
                if (Trim(A_LoopField260) == keyWordCurlyBraceClose_2) {
                    fixLuaAndRuby += StrReplace(A_LoopField260, keyWordCurlyBraceClose_2, Trim(keyWordEnd_2)) + Chr(10);
                }
                else if (SubStrLastChars(A_LoopField260, 2) == " " + keyWordCurlyBraceOpen_2) {
        ...
        if (langToConvertTo == "lua" || langToConvertTo == "rb" || langToConvertTo == langFileExtension_2) {
            if (langToConvertTo == langFileExtension_2 && useEnd_2 == "on") {
                ...
                for (let A_Index262 = 0; A_Index262 < items262.length; A_Index262++) {
                    ...
                    if (Trim(A_LoopField262) == "}") {
                        fixLuaAndRuby += StrReplace(A_LoopField262, "}", fixLuaAndRubyHELP) + Chr(10);
                    }
                    else if (SubStrLastChars(A_LoopField262, 2) == " {") {
                        fixLuaAndRuby += StringTrimRight(A_LoopField262, 2) + Chr(10);
                    } else {
                        fixLuaAndRuby += A_LoopField262 + Chr(10);
                    }
                }
                htCode = StringTrimRight(fixLuaAndRuby, 1);
            }
    ...
    if (langToConvertTo == langFileExtension_2 && useEnd_2 == "on") {
        ...
        for (let A_Index264 = 0; A_Index264 < items264.length; A_Index264++) {
            ...
            if (Trim(A_LoopField264) == Trim(keyWordEnd_2) && SubStr(Trim(nextWordEndFix[A_Index264 + 1]), 1, StrLen(Trim(keyWordElseIf_2) + " ")) == Trim(keyWordElseIf_2) + " " || Trim(A_LoopField264) == Trim(keyWordEnd_2) && (Trim(nextWordEndFix[A_Index264 + 1]) == Trim(keyWordElse_2) || Trim(nextWordEndFix[A_Index264 + 1]) == Trim(keyWordElse_2 + ":"))) {
                nextWordEndFixOut += "";
            } else {
    ...
    if (langToConvertTo == "lua") {
        ...
        for (let A_Index266 = 0; A_Index266 < items266.length; A_Index266++) {
            ...
            if (Trim(A_LoopField266) == "end" && SubStr(Trim(nextWordEndFix[A_Index266 + 1]), 1, StrLen("elseif ")) == "elseif " || Trim(A_LoopField266) == "end" && Trim(nextWordEndFix[A_Index266 + 1]) == "else") {
                nextWordEndFixOut += "";
            } else {
    ...
    if (langToConvertTo == "rb") {
        ...
        for (let A_Index267 = 0; A_Index267 < items267.length; A_Index267++) {
            ...
            HTVM_Append(nextWordEndFix, A_LoopField267);
        }
        HTVM_Append(nextWordEndFix, " ");
        ...
        for (let A_Index268 = 0; A_Index268 < items268.length; A_Index268++) {
            ...
            if (Trim(A_LoopField268) == "end" && SubStr(Trim(nextWordEndFix[A_Index268 + 1]), 1, StrLen("elsif ")) == "elsif " || Trim(A_LoopField268) == "end" && Trim(nextWordEndFix[A_Index268 + 1]) == "else") {
                nextWordEndFixOut += "";
            } else {
    ...
    if (langToConvertTo == "rb") {
        ...
        for (let A_Index270 = 0; A_Index270 < items270.length; A_Index270++) {
            ...
            if (Trim(A_LoopField270) == "end" && SubStr(Trim(nextWordEndFixRB[A_Index270 + 1]), 1, StrLen("rescue ")) == "rescue " || Trim(A_LoopField270) == "end" && Trim(nextWordEndFixRB[A_Index270 + 1]) == "ensure") {
                nextWordEndFixOut += "";
            } else {
    ...
    if (langToConvertTo == langFileExtension_2 && useEnd_2 == "on") {
        ...
        for (let A_Index271 = 0; A_Index271 < items271.length; A_Index271++) {
            ...
            HTVM_Append(nextWordEndFixRB, A_LoopField271);
        }
        HTVM_Append(nextWordEndFixRB, " ");
        ...
        for (let A_Index272 = 0; A_Index272 < items272.length; A_Index272++) {
            ...
            if (Trim(A_LoopField272) == Trim(keyWordEnd_2) && SubStr(Trim(nextWordEndFixRB[A_Index272 + 1]), 1, StrLen(Trim(keyWordCatch_2) + " ")) == Trim(keyWordCatch_2) + " " || Trim(A_LoopField272) == Trim(keyWordEnd_2) && Trim(nextWordEndFixRB[A_Index272 + 1]) == Trim(keyWordFinally_2) || Trim(nextWordEndFixRB[A_Index272 + 1]) == Trim(keyWordFinally_2 + ":")) {
                nextWordEndFixOut += "";
            } else {
    ...
    if (langToConvertTo == "ahk") {
        ...
        for (let A_Index273 = 0; A_Index273 < items273.length; A_Index273++) {
            ...
            if (SubStr(Trim(A_LoopField273), 1, StrLen("Loop, Parse, ")) == "Loop, Parse, ") {
                nextWordEndFixOut += StrReplace(A_LoopField273, "{", Chr(10) + "{" + Chr(10)) + Chr(10);
            } else {
                nextWordEndFixOut += A_LoopField273 + Chr(10);
            }
        }
        htCode = StringTrimRight(nextWordEndFixOut, 1);
    }
    if (langToConvertTo == "go") {
        ...
        for (let A_Index274 = 0; A_Index274 < items274.length; A_Index274++) {
            ...
            HTVM_Append(fixGoManGoIsSoAnnoyingBroooFurure, A_LoopField274);
        }
        ...
        for (let A_Index275 = 0; A_Index275 < items275.length; A_Index275++) {
            ...
            if (Trim(A_LoopField275) == "}" && SubStr(Trim(fixGoManGoIsSoAnnoyingBroooFurure[A_Index275 + 1]), 1, StrLen("else if ")) == "else if ") {
                fixGoManGoIsSoAnnoyingBroooSkip = 1;
                fixGoManGoIsSoAnnoyingBroooCount = 0;
                let items276 = LoopParseFunc(fixGoManGoIsSoAnnoyingBroooFurure[A_Index275 + 1]);
                ...
                for (let A_Index277 = 0; A_Index277 < fixGoManGoIsSoAnnoyingBroooCount; A_Index277++) {
                    fixGoManGoIsSoAnnoyingBroooCountSpaceses += " ";
                }
                fixGoManGoIsSoAnnoyingBrooo += fixGoManGoIsSoAnnoyingBroooCountSpaceses + "} " + Trim(fixGoManGoIsSoAnnoyingBroooFurure[A_Index275 + 1]) + Chr(10);
            } else {
                if (fixGoManGoIsSoAnnoyingBroooSkip == 0) {
                    fixGoManGoIsSoAnnoyingBrooo += A_LoopField275 + Chr(10);
                }
    ...
    if (COUNT_programmingBlock_InTheTranspiledLang != 0) {
        for (let A_Index278 = 0; A_Index278 < COUNT_programmingBlock_InTheTranspiledLang; A_Index278++) {
            htCode = StrReplace(htCode, "programmingBlock_InTheTranspiledLang-programmingBlock_InTheTranspiledLang-AA" + STR(A_Index278 + 1) + "AA", programmingBlock_InTheTranspiledLang[A_Index278]);
        }
    }
    if (langToConvertTo == "cpp") {
        if (COUNT_programmingBlock_CPP != 0) {
            for (let A_Index279 = 0; A_Index279 < COUNT_programmingBlock_CPP; A_Index279++) {
                htCode = StrReplace(htCode, "programmingBlock_CPP-programmingBlock_CPP-AA" + STR(A_Index279 + 1) + "AA", programmingBlock_CPP[A_Index279]);
            }
        }
    } else {
        if (COUNT_programmingBlock_CPP != 0) {
            for (let A_Index280 = 0; A_Index280 < COUNT_programmingBlock_CPP; A_Index280++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_CPP-programmingBlock_CPP-AA" + STR(A_Index280 + 1) + "AA", keyWordCodeInTheTranspiledLangStartCPP_2 + Chr(10) + programmingBlock_CPP[A_Index280] + Chr(10) + keyWordCodeInTheTranspiledLangEndCPP_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_CPP-programmingBlock_CPP-AA" + STR(A_Index280 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "py") {
        if (COUNT_programmingBlock_PY != 0) {
            for (let A_Index281 = 0; A_Index281 < COUNT_programmingBlock_PY; A_Index281++) {
                htCode = StrReplace(htCode, "programmingBlock_PY-programmingBlock_PY-AA" + STR(A_Index281 + 1) + "AA", programmingBlock_PY[A_Index281]);
            }
        }
    } else {
        if (COUNT_programmingBlock_PY != 0) {
            for (let A_Index282 = 0; A_Index282 < COUNT_programmingBlock_PY; A_Index282++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_PY-programmingBlock_PY-AA" + STR(A_Index282 + 1) + "AA", keyWordCodeInTheTranspiledLangStartPY_2 + Chr(10) + programmingBlock_PY[A_Index282] + Chr(10) + keyWordCodeInTheTranspiledLangEndPY_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_PY-programmingBlock_PY-AA" + STR(A_Index282 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "js") {
        if (COUNT_programmingBlock_JS != 0) {
            for (let A_Index283 = 0; A_Index283 < COUNT_programmingBlock_JS; A_Index283++) {
                htCode = StrReplace(htCode, "programmingBlock_JS-programmingBlock_JS-AA" + STR(A_Index283 + 1) + "AA", programmingBlock_JS[A_Index283]);
            }
        }
    } else {
        if (COUNT_programmingBlock_JS != 0) {
            for (let A_Index284 = 0; A_Index284 < COUNT_programmingBlock_JS; A_Index284++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_JS-programmingBlock_JS-AA" + STR(A_Index284 + 1) + "AA", keyWordCodeInTheTranspiledLangStartJS_2 + Chr(10) + programmingBlock_JS[A_Index284] + Chr(10) + keyWordCodeInTheTranspiledLangEndJS_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_JS-programmingBlock_JS-AA" + STR(A_Index284 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "go") {
        if (COUNT_programmingBlock_GO != 0) {
            for (let A_Index285 = 0; A_Index285 < COUNT_programmingBlock_GO; A_Index285++) {
                htCode = StrReplace(htCode, "programmingBlock_GO-programmingBlock_GO-AA" + STR(A_Index285 + 1) + "AA", programmingBlock_GO[A_Index285]);
            }
        }
    } else {
        if (COUNT_programmingBlock_GO != 0) {
            for (let A_Index286 = 0; A_Index286 < COUNT_programmingBlock_GO; A_Index286++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_GO-programmingBlock_GO-AA" + STR(A_Index286 + 1) + "AA", keyWordCodeInTheTranspiledLangStartGO_2 + Chr(10) + programmingBlock_GO[A_Index286] + Chr(10) + keyWordCodeInTheTranspiledLangEndGO_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_GO-programmingBlock_GO-AA" + STR(A_Index286 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "lua") {
        if (COUNT_programmingBlock_LUA != 0) {
            for (let A_Index287 = 0; A_Index287 < COUNT_programmingBlock_LUA; A_Index287++) {
                htCode = StrReplace(htCode, "programmingBlock_LUA-programmingBlock_LUA-AA" + STR(A_Index287 + 1) + "AA", programmingBlock_LUA[A_Index287]);
            }
        }
    } else {
        if (COUNT_programmingBlock_LUA != 0) {
            for (let A_Index288 = 0; A_Index288 < COUNT_programmingBlock_LUA; A_Index288++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_LUA-programmingBlock_LUA-AA" + STR(A_Index288 + 1) + "AA", keyWordCodeInTheTranspiledLangStartLUA_2 + Chr(10) + programmingBlock_LUA[A_Index288] + Chr(10) + keyWordCodeInTheTranspiledLangEndLUA_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_LUA-programmingBlock_LUA-AA" + STR(A_Index288 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "cs") {
        if (COUNT_programmingBlock_CS != 0) {
            for (let A_Index289 = 0; A_Index289 < COUNT_programmingBlock_CS; A_Index289++) {
                htCode = StrReplace(htCode, "programmingBlock_CS-programmingBlock_CS-AA" + STR(A_Index289 + 1) + "AA", programmingBlock_CS[A_Index289]);
            }
        }
    } else {
        if (COUNT_programmingBlock_CS != 0) {
            for (let A_Index290 = 0; A_Index290 < COUNT_programmingBlock_CS; A_Index290++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_CS-programmingBlock_CS-AA" + STR(A_Index290 + 1) + "AA", keyWordCodeInTheTranspiledLangStartCS_2 + Chr(10) + programmingBlock_CS[A_Index290] + Chr(10) + keyWordCodeInTheTranspiledLangEndCS_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_CS-programmingBlock_CS-AA" + STR(A_Index290 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "java") {
        if (COUNT_programmingBlock_JAVA != 0) {
            for (let A_Index291 = 0; A_Index291 < COUNT_programmingBlock_JAVA; A_Index291++) {
                htCode = StrReplace(htCode, "programmingBlock_JAVA-programmingBlock_JAVA-AA" + STR(A_Index291 + 1) + "AA", programmingBlock_JAVA[A_Index291]);
            }
        }
    } else {
        if (COUNT_programmingBlock_JAVA != 0) {
            for (let A_Index292 = 0; A_Index292 < COUNT_programmingBlock_JAVA; A_Index292++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_JAVA-programmingBlock_JAVA-AA" + STR(A_Index292 + 1) + "AA", keyWordCodeInTheTranspiledLangStartJAVA_2 + Chr(10) + programmingBlock_JAVA[A_Index292] + Chr(10) + keyWordCodeInTheTranspiledLangEndJAVA_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_JAVA-programmingBlock_JAVA-AA" + STR(A_Index292 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "kt") {
        if (COUNT_programmingBlock_KT != 0) {
            for (let A_Index293 = 0; A_Index293 < COUNT_programmingBlock_KT; A_Index293++) {
                htCode = StrReplace(htCode, "programmingBlock_KT-programmingBlock_KT-AA" + STR(A_Index293 + 1) + "AA", programmingBlock_KT[A_Index293]);
            }
        }
    } else {
        if (COUNT_programmingBlock_KT != 0) {
            for (let A_Index294 = 0; A_Index294 < COUNT_programmingBlock_KT; A_Index294++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_KT-programmingBlock_KT-AA" + STR(A_Index294 + 1) + "AA", keyWordCodeInTheTranspiledLangStartKT_2 + Chr(10) + programmingBlock_KT[A_Index294] + Chr(10) + keyWordCodeInTheTranspiledLangEndKT_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_KT-programmingBlock_KT-AA" + STR(A_Index294 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "rb") {
        if (COUNT_programmingBlock_RB != 0) {
            for (let A_Index295 = 0; A_Index295 < COUNT_programmingBlock_RB; A_Index295++) {
                htCode = StrReplace(htCode, "programmingBlock_RB-programmingBlock_RB-AA" + STR(A_Index295 + 1) + "AA", programmingBlock_RB[A_Index295]);
            }
        }
    } else {
        if (COUNT_programmingBlock_RB != 0) {
            for (let A_Index296 = 0; A_Index296 < COUNT_programmingBlock_RB; A_Index296++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_RB-programmingBlock_RB-AA" + STR(A_Index296 + 1) + "AA", keyWordCodeInTheTranspiledLangStartRB_2 + Chr(10) + programmingBlock_RB[A_Index296] + Chr(10) + keyWordCodeInTheTranspiledLangEndRB_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_RB-programmingBlock_RB-AA" + STR(A_Index296 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "nim") {
        if (COUNT_programmingBlock_NIM != 0) {
            for (let A_Index297 = 0; A_Index297 < COUNT_programmingBlock_NIM; A_Index297++) {
                htCode = StrReplace(htCode, "programmingBlock_NIM-programmingBlock_NIM-AA" + STR(A_Index297 + 1) + "AA", programmingBlock_NIM[A_Index297]);
            }
        }
    } else {
        if (COUNT_programmingBlock_NIM != 0) {
            for (let A_Index298 = 0; A_Index298 < COUNT_programmingBlock_NIM; A_Index298++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_NIM-programmingBlock_NIM-AA" + STR(A_Index298 + 1) + "AA", keyWordCodeInTheTranspiledLangStartNIM_2 + Chr(10) + programmingBlock_NIM[A_Index298] + Chr(10) + keyWordCodeInTheTranspiledLangEndNIM_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_NIM-programmingBlock_NIM-AA" + STR(A_Index298 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "ahk") {
        if (COUNT_programmingBlock_AHK != 0) {
            for (let A_Index299 = 0; A_Index299 < COUNT_programmingBlock_AHK; A_Index299++) {
                htCode = StrReplace(htCode, "programmingBlock_AHK-programmingBlock_AHK-AA" + STR(A_Index299 + 1) + "AA", programmingBlock_AHK[A_Index299]);
            }
        }
    } else {
        if (COUNT_programmingBlock_AHK != 0) {
            for (let A_Index300 = 0; A_Index300 < COUNT_programmingBlock_AHK; A_Index300++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_AHK-programmingBlock_AHK-AA" + STR(A_Index300 + 1) + "AA", keyWordCodeInTheTranspiledLangStartAHK_2 + Chr(10) + programmingBlock_AHK[A_Index300] + Chr(10) + keyWordCodeInTheTranspiledLangEndAHK_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_AHK-programmingBlock_AHK-AA" + STR(A_Index300 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "swift") {
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (let A_Index301 = 0; A_Index301 < COUNT_programmingBlock_SWIFT; A_Index301++) {
                htCode = StrReplace(htCode, "programmingBlock_SWIFT-programmingBlock_SWIFT-AA" + STR(A_Index301 + 1) + "AA", programmingBlock_SWIFT[A_Index301]);
            }
        }
    } else {
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (let A_Index302 = 0; A_Index302 < COUNT_programmingBlock_SWIFT; A_Index302++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_SWIFT-programmingBlock_SWIFT-AA" + STR(A_Index302 + 1) + "AA", keyWordCodeInTheTranspiledLangStartSWIFT_2 + Chr(10) + programmingBlock_SWIFT[A_Index302] + Chr(10) + keyWordCodeInTheTranspiledLangEndSWIFT_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_SWIFT-programmingBlock_SWIFT-AA" + STR(A_Index302 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "dart") {
        if (COUNT_programmingBlock_DART != 0) {
            for (let A_Index303 = 0; A_Index303 < COUNT_programmingBlock_DART; A_Index303++) {
                htCode = StrReplace(htCode, "programmingBlock_DART-programmingBlock_DART-AA" + STR(A_Index303 + 1) + "AA", programmingBlock_DART[A_Index303]);
            }
        }
    } else {
        if (COUNT_programmingBlock_DART != 0) {
            for (let A_Index304 = 0; A_Index304 < COUNT_programmingBlock_DART; A_Index304++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_DART-programmingBlock_DART-AA" + STR(A_Index304 + 1) + "AA", keyWordCodeInTheTranspiledLangStartDART_2 + Chr(10) + programmingBlock_DART[A_Index304] + Chr(10) + keyWordCodeInTheTranspiledLangEndDART_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_DART-programmingBlock_DART-AA" + STR(A_Index304 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "ts") {
        if (COUNT_programmingBlock_TS != 0) {
            for (let A_Index305 = 0; A_Index305 < COUNT_programmingBlock_TS; A_Index305++) {
                htCode = StrReplace(htCode, "programmingBlock_TS-programmingBlock_TS-AA" + STR(A_Index305 + 1) + "AA", programmingBlock_TS[A_Index305]);
            }
        }
    } else {
        if (COUNT_programmingBlock_TS != 0) {
            for (let A_Index306 = 0; A_Index306 < COUNT_programmingBlock_TS; A_Index306++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_TS-programmingBlock_TS-AA" + STR(A_Index306 + 1) + "AA", keyWordCodeInTheTranspiledLangStartTS_2 + Chr(10) + programmingBlock_TS[A_Index306] + Chr(10) + keyWordCodeInTheTranspiledLangEndTS_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_TS-programmingBlock_TS-AA" + STR(A_Index306 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "groovy") {
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (let A_Index307 = 0; A_Index307 < COUNT_programmingBlock_GROOVY; A_Index307++) {
                htCode = StrReplace(htCode, "programmingBlock_GROOVY-programmingBlock_GROOVY-AA" + STR(A_Index307 + 1) + "AA", programmingBlock_GROOVY[A_Index307]);
            }
        }
    } else {
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (let A_Index308 = 0; A_Index308 < COUNT_programmingBlock_GROOVY; A_Index308++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_GROOVY-programmingBlock_GROOVY-AA" + STR(A_Index308 + 1) + "AA", keyWordCodeInTheTranspiledLangStartGROOVY_2 + Chr(10) + programmingBlock_GROOVY[A_Index308] + Chr(10) + keyWordCodeInTheTranspiledLangEndGROOVY_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_GROOVY-programmingBlock_GROOVY-AA" + STR(A_Index308 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    ...
    if (langToConvertTo == langFileExtension_2) {
        if (COUNT_programmingBlock_HTVM != 0) {
            for (let A_Index309 = 0; A_Index309 < COUNT_programmingBlock_HTVM; A_Index309++) {
                htCode = StrReplace(htCode, "programmingBlock_HTVM-programmingBlock_HTVM-AA" + STR(A_Index309 + 1) + "AA", programmingBlock_HTVM[A_Index309]);
            }
        }
    } else {
        if (COUNT_programmingBlock_HTVM != 0) {
            for (let A_Index310 = 0; A_Index310 < COUNT_programmingBlock_HTVM; A_Index310++) {
                htCode = StrReplace(htCode, "programmingBlock_HTVM-programmingBlock_HTVM-AA" + STR(A_Index310 + 1) + "AA", Chr(10));
            }
        }
    }
    if (langToConvertTo != langFileExtension_2) {
        ...
        ALoopField = "";
        str23 = "";
        let items311 = LoopParseFunc(htCode, "\n", "\r");
        for (let A_Index311 = 0; A_Index311 < items311.length; A_Index311++) {
            const A_LoopField311 = items311[A_Index311 - 0];
            ALoopField = A_LoopField311;
            if (InStr(A_LoopField311, "fihuiuuhuuhtheidFor--asds")) {
                ...
                for (let A_Index312 = 0; A_Index312 < theIdNumOfThe34; A_Index312++) {
                    if (theIdNumOfThe34 == A_Index312 + 1) {
                        if (langToConvertTo == langFileExtension_2) {
                            if (keyWordEscpaeChar_2 == "\\" && keyWordEscpaeChar != "\\") {
                                ALoopField = StrReplace(ALoopField, "fihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index312 + 1) + Chr(65) + Chr(65), StrReplace(StrReplace(fString(theIdNumOfThe34theVar[A_Index312 + 1]), "\\", "\\\\"), keyWordEscpaeChar, keyWordEscpaeChar_2) + Chr(34));
                            } else {
                                ALoopField = StrReplace(ALoopField, "fihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index312 + 1) + Chr(65) + Chr(65), StrReplace(fString(theIdNumOfThe34theVar[A_Index312 + 1]), keyWordEscpaeChar, keyWordEscpaeChar_2) + Chr(34));
                            }
                        } else {
                            ALoopField = StrReplace(ALoopField, "fihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index312 + 1) + Chr(65) + Chr(65), StrReplace(fString(theIdNumOfThe34theVar[A_Index312 + 1]), keyWordEscpaeChar, "\\") + Chr(34));
                        }
                    } else {
                        if (langToConvertTo == langFileExtension_2) {
                            if (keyWordEscpaeChar_2 == "\\" && keyWordEscpaeChar != "\\") {
                                ALoopField = StrReplace(ALoopField, "fihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index312 + 1) + Chr(65) + Chr(65), StrReplace(StrReplace(fString(theIdNumOfThe34theVar[A_Index312 + 1]), "\\", "\\\\"), keyWordEscpaeChar, keyWordEscpaeChar_2));
                            } else {
                                ALoopField = StrReplace(ALoopField, "fihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index312 + 1) + Chr(65) + Chr(65), StrReplace(fString(theIdNumOfThe34theVar[A_Index312 + 1]), keyWordEscpaeChar, keyWordEscpaeChar_2));
                            }
                        } else {
                            ALoopField = StrReplace(ALoopField, "fihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index312 + 1) + Chr(65) + Chr(65), StrReplace(fString(theIdNumOfThe34theVar[A_Index312 + 1]), keyWordEscpaeChar, "\\"));
                        }
                    }
                }
            }
    ...
    var correctLang = 0;
    let items313 = LoopParseFunc(instructions, "\n", "\r");
    for (let A_Index313 = 0; A_Index313 < items313.length; A_Index313++) {
        const A_LoopField313 = items313[A_Index313 - 0];
        if (Trim(A_LoopField313) == "funcEND======================funcEND==============") {
            areWeInAFuncFromInstructions = 0;
            areWeInAFuncFromInstructionsLineNum = 0;
        ...
        if (areWeInAFuncFromInstructions == 1) {
            if (areWeInAFuncFromInstructionsLineNum == 1) {
                // lang of the func
                funcLangHolder = StringTrimLeft(A_LoopField313, 5);
            ...
            if (areWeInAFuncFromInstructionsLineNum == 2) {
                // name of the func
                funcNameHolder = StringTrimLeft(A_LoopField313, 5);
                if (correctLang == 1 && InStr(htCode, Trim(funcNameHolder) + "(")) {
            ...
            if (areWeInAFuncFromInstructionsLineNum == 3) {
                // all libs
                funcLibsHolder = StringTrimLeft(A_LoopField313, 5);
                if (correctLang == 1 && InStr(htCode, Trim(funcNameHolder) + "(")) {
            ...
            if (areWeInAFuncFromInstructionsLineNum == 4) {
                // func description
                funcDescriptionHolder = StringTrimLeft(A_LoopField313, 12);
                if (correctLang == 1 && InStr(htCode, Trim(funcNameHolder) + "(")) {
            ...
            if (areWeInAFuncFromInstructionsLineNum >= 5) {
                // the full func
                if (correctLang == 1 && InStr(htCode, Trim(funcNameHolder) + "(")) {
                    funcFuncHolder += A_LoopField313 + Chr(10);
                }
            }
            //MsgBox, % A_LoopField
            areWeInAFuncFromInstructionsLineNum++;
        }
        if (Trim(A_LoopField313) == "func======================func==============") {
    ...
    if (isNotHTVMfile2 == 0) {
        ...
        for (let A_Index314 = 0; A_Index314 < HTVM_Size(commentsBugFix); A_Index314++) {
            htCode = StrReplace(htCode, "HTVM--cnavisdofbuvsesdivdidufg79wregwewaeosd8ges7dfdftuawdiHTVMv2yerheyziberlasduci6syiq--AA" + STR(A_Index314) + "AA", commentsBugFix[A_Index314]);
        }
    ...
    if (!(HTVM_Size(allFuncNames) <= 0)) {
        for (let A_Index315 = 0; A_Index315 < HTVM_Size(allFuncNames); A_Index315++) {
            if (InStr(htCode, allFuncNames[A_Index315]) + "(") {
                //MsgBox, % allFuncNames[A_Index]
                allFuncsToPutAtTop += allFuncs[A_Index315] + Chr(10);
                if (Trim(allFuncLibs[A_Index315]) != "null") {
                    allLibsToPutAtTop += allFuncLibs[A_Index315] + "|";
                }
            }
        }
        allLibsToPutAtTop = StringTrimRight(allLibsToPutAtTop, 1);
        var allLibsToPutAtTopTEMP = "";
        let items316 = LoopParseFunc(allLibsToPutAtTop, "|");
        for (let A_Index316 = 0; A_Index316 < items316.length; A_Index316++) {
            const A_LoopField316 = items316[A_Index316 - 0];
            allLibsToPutAtTopTEMP += A_LoopField316 + Chr(10);
        }
    ...
    if (langToConvertTo != langFileExtension_2) {
        for (let A_Index317 = 0; A_Index317 < HTVM_Size(ospDic1); A_Index317++) {
            str00 = ospDic1[A_Index317];
            if (langToConvertTo == "rb") {
    ...
    if (size_ospDic != 0) {
        for (let A_Index318 = 0; A_Index318 < size_ospDic; A_Index318++) {
            HTVM_Pop(ospDic);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic1 != 0) {
        for (let A_Index319 = 0; A_Index319 < size_ospDic1; A_Index319++) {
            HTVM_Pop(ospDic1);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic2 != 0) {
        for (let A_Index320 = 0; A_Index320 < size_ospDic2; A_Index320++) {
            HTVM_Pop(ospDic2);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_htCodeFixRubyGlobalVars_EXPOSED != 0) {
        for (let A_Index321 = 0; A_Index321 < size_htCodeFixRubyGlobalVars_EXPOSED; A_Index321++) {
    ...
    for (let A_Index322 = 0; A_Index322 < theIdNumOfThe34; A_Index322++) {
        if (theIdNumOfThe34 == A_Index322 + 1) {
            if (langToConvertTo == langFileExtension_2) {
                if (keyWordEscpaeChar_2 == "\\" && keyWordEscpaeChar != "\\") {
                    htCode = StrReplace(htCode, "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index322 + 1) + Chr(65) + Chr(65), StrReplace(StrReplace(theIdNumOfThe34theVar[A_Index322 + 1], "\\", "\\\\"), keyWordEscpaeChar, keyWordEscpaeChar_2) + Chr(34));
                } else {
                    htCode = StrReplace(htCode, "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index322 + 1) + Chr(65) + Chr(65), StrReplace(theIdNumOfThe34theVar[A_Index322 + 1], keyWordEscpaeChar, keyWordEscpaeChar_2) + Chr(34));
                }
            } else {
                htCode = StrReplace(htCode, "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index322 + 1) + Chr(65) + Chr(65), StrReplace(theIdNumOfThe34theVar[A_Index322 + 1], keyWordEscpaeChar, "\\") + Chr(34));
            }
        } else {
            if (langToConvertTo == langFileExtension_2) {
                if (keyWordEscpaeChar_2 == "\\" && keyWordEscpaeChar != "\\") {
                    htCode = StrReplace(htCode, "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index322 + 1) + Chr(65) + Chr(65), StrReplace(StrReplace(theIdNumOfThe34theVar[A_Index322 + 1], "\\", "\\\\"), keyWordEscpaeChar, keyWordEscpaeChar_2));
                } else {
                    htCode = StrReplace(htCode, "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index322 + 1) + Chr(65) + Chr(65), StrReplace(theIdNumOfThe34theVar[A_Index322 + 1], keyWordEscpaeChar, keyWordEscpaeChar_2));
                }
            } else {
                htCode = StrReplace(htCode, "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index322 + 1) + Chr(65) + Chr(65), StrReplace(theIdNumOfThe34theVar[A_Index322 + 1], keyWordEscpaeChar, "\\"));
            }
        }
    }
    if (langToConvertTo == langFileExtension_2) {
    ...
    if (isNotHTVMfile2 == 0) {
        ...
        if (langToConvertTo == langFileExtension_2) {
            for (let A_Index323 = 0; A_Index323 < HTVM_Size(weAreInMLSarr); A_Index323++) {
                htCode = StrReplace(htCode, "aejsoydoxubviycbdgsut7eoy-ihsxbvhowadesdio6376e7wuwyuau--szd--AA" + STR(A_Index323) + "AA", weAreInMLSarr[A_Index323]);
            }
    ...
    if (size_weAreInMLSarr != 0) {
        for (let A_Index324 = 0; A_Index324 < size_weAreInMLSarr; A_Index324++) {
...
function HTVMv2() {
    ...
    if (HTVM_getLang_HTVM() == "cpp" || HTVM_getLang_HTVM() == "py") {
        ...
        let items326 = LoopParseFunc(allArgs, "\n", "\r");
        for (let A_Index326 = 0; A_Index326 < items326.length; A_Index326++) {
            const A_LoopField326 = items326[A_Index326 - 0];
            if (A_Index326 == 0) {
                numOfParams++;
                argCODE = FileRead(Trim(A_LoopField326));
                argCODEfile = Trim(A_LoopField326);
            }
            else if (A_Index326 == 1) {
                numOfParams++;
                argHTVMinstr = Trim(A_LoopField326);
            }
            else if (A_Index326 == 2) {
                numOfParams++;
                argLangTo = Trim(A_LoopField326);
            } else {
                numOfParams++;
                HTVM_Append(argHTVMinstrMORE, Trim(A_LoopField326));
            }
        }
        //print("===============123431234===========start=====")
        for (let A_Index327 = 0; A_Index327 < HTVM_Size(argHTVMinstrMORE); A_Index327++) {
