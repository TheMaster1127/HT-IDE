...
const hotkeyConfig = {
    ...
    newProject:   { label: 'New Project', default: { key: 'n', ctrl: true, shift: false, alt: false } },
    mapLine:      { label: 'Map Target Line to HTVM', default: { key: 'm', ctrl: true, shift: false, alt: true } },
};
...
const uiThemeConfig = {
    ...
    '--btn-map-line-bg': { label: 'Map Line Button BG', default: '#0e639c', type: 'color', category: 'Top Bar', description: 'Background color for the "Map Line" button (visible on mobile).' },
    '--btn-map-line-text': { label: 'Map Line Button Text', default: '#ffffff', type: 'color', category: 'Top Bar', description: 'Text color for the "Map Line" button.', hasBoldToggle: true, defaultBold: false },
